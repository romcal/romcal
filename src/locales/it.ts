...
export default {
  ...
  sanctoral: {
    ...
    saint_adalbert_bishop: 'Sant’Adalberto, vescovo e martire',
    saint_agatha_of_sicily_virgin: 'Sant’Agata, vergine e martire',
    saint_agnes_of_rome_virgin: 'Sant’Agnese, vergine e martire',
