export default {
  ...
  "general": {
    ...
    "saintBirgittaReligious": "Św. Brygidy, zakonnicy, patronki Europy",
    "saintSharbelMakhlufPriestAndHermit": "Św. Sarbeliusza Makluf, prezbitera",
    ...
    "saintRoseOfLimaVirgin": "Św. Róży z Limy, dziewicy",
  ...
  "national": {
    ...
    "saintBridgetOfSweedenReligious": "Św. Brygidy, zakonnicy, patronki Europy",
