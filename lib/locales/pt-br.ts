...
export const locale: Locale = {
  ...
  names: {
    ...
    agatha_of_sicily_virgin: 'Santa Ágata (Águeda) da Sicília, virgem e mártir',
    ...
    andrew_de_soveral_and_ambrose_francis_ferro_priests: 'Santo André de Soveral e Santo Ambrósio Francisco Ferro, sacerdotes e mártires',
    andrew_dung_lac_priest_and_companions_martyrs: 'Santo André Dũng-Lạc e companheiros, mártires',
    andrew_kim_tae_gon_priest_paul_chong_ha_sang_and_companions_martyrs: 'Santo André Kim Taegon, sacerdote, São Paulo Chong Hasang e companheiros, mártires',
    ...
    ansgar_of_hamburg_bishop: 'Santo Ansgário (Anscário ou Óscar) de Hamburgo, bispo',
    anthony_mary_claret_bishop: 'Santo Antônio Maria Claret, bispo',
    anthony_of_egypt_abbot: 'Santo Antônio do Egito, abade',
    anthony_of_padua_priest: 'Santo Antônio de Pádua, sacerdote e doutor da Igreja',
    anthony_of_saint_anne_galvao_priest: "Santo Antônio de Sant'Anna Galvão, sacerdote",
    anthony_zaccaria_priest: 'Santo Antônio Maria Zaccaria, sacerdote',
    apollinaris_of_ravenna_bishop: 'Santo Apolinário de Ravena, bispo',
    ...
    athanasius_of_alexandria_bishop: 'Santo Atanásio de Alexandria, bispo',
    audoen_of_rouen_bishop: 'São Audoeno, bispo',
    augustine_of_canterbury_bishop: 'Santo Agostinho de Cantuária, bispo',
    augustine_of_hippo_bishop: 'Santo Agostinho de Hipona, bispo e doutor da Igreja',
    augustine_zhao_rong_priest_and_companions_martyrs: 'Santo agostinho zhao rong, sacerdote, e companheiros, mártires',
    ...
    bartholomew_of_the_martyrs_fernandes_bishop: 'São Bartolomeu dos mártires Fernandes, bispo',
    basil_the_great_and_gregory_nazianzen_bishops: 'São Basílio Magno e São Gregório Nazianzeno, bispos',
    beatrice_da_silva_meneses_virgin: 'Santa Beatriz da Silva Meneses, virgem',
    bede_the_venerable_priest: 'São Beda, o Venerável, sacerdote e doutor da Igreja',
    benedict_of_aniane_abbot: 'São Bento de Aniane, abade',
    benedict_of_nursia_abbot: 'São Bento de Núrsia, abade',
    bernard_of_clairvaux_abbot: 'São Bernardo de Claraval, abade e doutor da Igreja',
    bernardine_of_siena_priest: 'São Bernardino de Siena, sacerdote',
    blaise_of_sebaste_bishop: 'São Brás de Sebaste, bispo e mártir',
    blessed_martyrs_of_paris: 'Beatos mártires da Revolução Francesa',
    bonaventure_of_bagnoregio_bishop: 'São Boaventura de Bagnoregio, bispo e doutor da Igreja',
    boniface_of_mainz_bishop: 'São Bonifácio, bispo e mártir',
    bridget_of_sweden_religious: 'Santa Brígida da Suécia, religiosa',
    ...
    bruno_of_cologne_priest: 'São Bruno de Colônia, sacerdote',
    cajetan_of_thiene_priest: 'São Caetano de Thiene, sacerdote',
    callistus_i_pope: 'São Calisto I, papa',
    camillus_de_lellis_priest: 'São Camilo de Léllis, sacerdote',
    carmelites_of_compiegne_virgins_and_martyrs: 'Beatas Carmelitas de Compiègne, virgens e mártires',
    casimir_of_poland: 'São Casimiro da Polônia',
    catherine_of_alexandria_virgin: 'Santa Catarina de Alexandria, virgem',
    catherine_of_siena_virgin: 'Santa Catarina de Sena, virgem',
    catherine_zoe_laboure_virgin: 'Santa Catarina Labouré, virgem',
    cecilia_of_rome_virgin: 'Santa Cecília de Roma, virgem e mártir',
    ceraunus_of_paris_bishop: 'São Cerauno de Paris, bispo',
    chair_of_saint_peter_the_apostle: 'Cátedra de São Pedro o apóstolo',
    charles_borromeo_bishop: 'São Carlos Borromeu, bispo',
    charles_lwanga_and_companions_martyrs: 'São Carlos Lwanga e companheiros, mártires',
    charles_of_jesus_de_foucauld: 'São Carlos de Foucauld, presbítero',
    christopher_magallanes_priest_and_companions_martyrs: 'São Cristóvão Magallanes, sacerdote, e companheiros, mártires',
    clare_of_assisi_virgin: 'Santa Clara de Assis, virgem',
    clement_i_pope: 'São Clemente I, papa e mártir',
    columban_of_luxeuil_abbot: 'São Columbano de Luxeuil, abade e fundador de mosteiros',
    ...
    cornelius_i_pope_and_cyprian_of_carthage_bishop_martyrs: 'São Cornélio, papa, e São Cipriano de Cartago, bispo, mártires',
    cosmas_of_cilicia_and_damian_of_cilicia_martyrs: 'São Cosme e São Damião, mártires',
    ...
    dedication_of_consecrated_churches_on_last_sunday_of_october: 'Dedicação de Igrejas Consagradas no Último Domingo de Outubro',
    dedication_of_consecrated_churches_on_october_25: 'Dedicação de Igrejas Consagradas em 25 de Outubro',
    ...
    dominic_de_guzman_priest: 'São Domingos de Gusmão, sacerdote',
    ...
    eusebius_of_vercelli_bishop: 'São Eusébio de Vercelli, bispo',
    exaltation_of_the_holy_cross: 'Exaltação da Santa Cruz',
    fabian_i_pope: 'São Fabiano, papa',
    faustina_kowalska_virgin: 'Santa Faustina Kowalska, virgem',
    fidelis_of_sigmaringen_priest: 'São Fidelis (Fiel) de Sigmaringa, sacerdote',
    ...
    francis_of_assisi: 'São Francisco de Assis',
    francis_of_paola_hermit: 'São Francisco de Paula',
    francis_xavier_priest: 'São Francisco Xavier, sacerdote',
    ...
    gertrude_the_great_virgin: 'Santa Gertrudes Magna, virgem',
    ...
    gundisalvus_of_amarante_priest: 'São Gonçalo de Amarante, sacerdote',
    gundisalvus_of_lagos_priest: 'São Gonçalo de Lagos, sacerdote',
    hedwig_of_silesia_religious: 'Santa Edviges da Silésia, religiosa',
    henry_ii_emperor: 'Santo Henrique II',
    hilary_of_poitiers_bishop: 'Santo Hilário de Poitiers, bispo',
    ...
    ignatius_de_azevedo_priest_and_companions_martyrs: 'Beato Inácio de Azevedo, sacerdote, e companheiros, mártires',
    ignatius_of_antioch_bishop: 'Santo Inácio de Antioquia, bispo y mártir',
    ignatius_of_loyola_priest: 'Santo Inácio de Loyola, sacerdote',
    ...
    jacinta_marto_and_francisco_marto: 'São Francisco e Santa Jacinta Marto',
    james_apostle: 'São Tiago Maior (Santiago), apóstolo',
    jane_frances_de_chantal_religious: 'Santa Joana Francisca de Chantal, religiosa',
    januarius_i_of_benevento_bishop: 'Santo Januário de Benevento, bispo, mártir',
    jerome_emiliani: 'São Jerônimo Emiliani',
    jerome_of_stridon_priest: 'São Jerônimo, sacerdote, doutor da Igreja',
    joachim_and_anne_parents_of_mary: 'Santos Joaquim e Ana, Pais de Nossa Senhora',
    joan_of_portugal_virgin: 'Beata Joana, Princesa de Portugal, virgem',
    john_apostle: 'São João Evangelista, apóstolo',
    john_baptist_de_la_salle_priest: 'São João Batista de La Salle, sacerdote',
    john_bosco_priest: 'São João Bosco, sacerdote',
    john_chrysostom_bishop: 'São João Crisóstomo, bispo',
    john_damascene_priest: 'São João Damasceno, sacerdote',
    john_de_brebeuf_isaac_jogues_priests_and_companions_martyrs: 'São João de Brebeuf, Isaac Jogues e companheiros, mártires',
    john_de_britto_priest: 'São João de Brito, sacerdote e mártir',
    john_eudes_priest: 'São João Eudes, sacerdote',
    john_fisher_bishop_and_thomas_more_martyrs: 'São João Fisher, bispo, e Tomás More, mártires',
    john_i_pope: 'São João I, papa e mártir',
    john_leonardi_priest: 'São João Leonardi, sacerdote',
    john_mary_vianney_priest: 'São João Maria Vianney, sacerdote',
    john_of_avila_priest: 'São João De Ávila, presbítero e doutor da Igreja',
    john_of_capistrano_priest: 'São João de Capistrano, sacerdote',
    john_of_god_duarte_cidade_religious: 'São João de Deus, Duarte Cidade, religioso',
    john_of_kanty_priest: 'São João de Kęty, sacerdote',
    john_of_the_cross_priest: 'São João da Cruz, sacerdote',
    john_paul_ii_pope: 'Papa São João Paulo II',
    john_xxiii_pope: 'Papa São João XXIII',
    josaphat_kuntsevych_bishop: 'São Josafá Kuntsevych, bispo',
    joseph_de_anchieta_priest: 'São José de Anchieta, sacerdote',
    joseph_of_calasanz_priest: 'São José de Calasanz, sacerdote',
    ...
    juan_diego_cuauhtlatoatzin: 'São João Diogo (Juan Diego) Cuauhtlatoatzin, sacerdote',
    justin_martyr: 'São Justino, mártir',
    landry_of_paris_bishop: 'São Landry de Paris, bispo',
    lawrence_of_brindisi_priest: 'São Lourenço de Brindisi, sacerdote',
    lawrence_of_rome_deacon: 'São Lourenço de Roma, diácono',
    lawrence_ruiz_and_companions_martyrs: 'São Lourenço Ruiz e companheiros, mártires',
    leo_i_the_great_pope: 'São Leão Magno, papa e doutor da Igreja',
    leodegar_of_autun_bishop: 'São Leodegar de Autun, bispo e mártir',
    louis_grignion_de_montfort_priest: 'São Luís Maria Grignion de Montfort, sacerdote',
    louis_ix_of_france: 'São Luís IX',
    louise_de_marillac_religious: 'Santa Luísa de Marillac, religiosa',
    lucy_of_syracuse_virgin: 'Santa Luzia (Lúcia) de Siracusa, virgem e mártir',
    ...
    marcellinus_of_rome_and_peter_the_exorcist_martyrs: 'São Marcelino de Roma e São Pedro, o Exorcista, mártires',
    ...
    mark_evangelist: 'São Marcos, o evangelista',
    ...
    mary_mother_of_the_church: 'Maria, Mãe da Igreja',
    ...
    michael_gabriel_and_raphael_archangels: 'São Miguel, Gabriel e Rafael, arcanjos',
    ...
    most_holy_body_and_blood_of_christ: 'Santíssimo Corpo e Sangue de Cristo - Corpus Christi',
    ...
    nativity_of_the_blessed_virgin_mary: 'Natividade da virgem Maria',
    nativity_of_the_lord: 'Natal',
    nereus_of_terracina_and_achilleus_of_terracina_martyrs: 'Santos Nereu e Aquileu, mártires de Terracina',
    nicholas_barre_priest: 'Beato Nicolau Barré, presbítero',
    nicholas_of_myra_bishop: 'São Nicolau de Mira, bispo',
    norbert_of_xanten_bishop: 'São Norberto de Xanten, bispo',
    nuno_of_saint_mary_pereira_religious: 'São Nuno de Santa Maria Pereira, religioso',
    ...
    pancras_of_rome_martyr: 'São Pancrácio, mártir de Roma',
    passion_of_saint_john_the_baptist: 'Paixão de São João Batista',
    patrick_of_ireland_bishop: 'São Patrício, bispo da Irlanda',
    paul_miki_and_companions_martyrs: 'São Paulo Miki e companheiros, mártires',
    paul_of_the_cross_priest: 'São Paulo da Cruz, sacerdote',
    ...
    perpetua_of_carthage_and_felicity_of_carthage_martyrs: 'Santas Perpétua de Cartago e Felicidade de Cartago, mártires',
    peter_and_paul_apostles: 'São Pedro e São Paulo, Apóstolos',
    peter_canisius_priest: 'São Pedro Canísio, sacerdote',
    peter_chanel_priest: 'São Pedro Chanel, sacerdote',
    peter_chrysologus_bishop: 'São Pedro Crisólogo, bispo',
    peter_claver_priest: 'São Pedro Claver, sacerdote',
    peter_damian_bishop: 'São Pedro Damião, bispo e doutor da Igreja',
    peter_julian_eymard_priest: 'São Pedro Julião Eymard, sacerdote',
    philip_and_james_apostles: 'São Filipe e Tiago, apóstolos',
    philip_neri_priest: 'São Filipe Néri, sacerdote',
    pius_francesco_forgione_priest: 'São Pio de Pietrelcina, presbítero',
    pius_v_pope: 'São Pio V, papa',
    pius_x_pope: 'São Pio X, papa',
    polycarp_of_smyrna_bishop: 'São Policarpo de Esmirna, bispo',
    pontian_i_pope_and_hippolytus_of_rome_priest: 'Santos Pôncio I, papa, e Hipólito de Roma, sacerdote',
    ...
    raymond_of_penyafort_priest: 'São Raimundo de Penyafort, sacerdote',
    ...
    roch_gonzalez_alphonsus_rodriguez_and_john_del_castillo_priests: 'São Roque González Alfonso Rodríguez e São João del Castillo, sacerdotes e mártires',
    romuald_of_ravenna_abbot: 'São Romualdo de Ravena, abade',
    rosalie_jeanne_marie_rendu_virgin: 'Beata Rosália Rendu, virgem',
    rose_of_lima_virgin: 'Santa Rosa de Lima, virgem',
    sancha_of_portugal_and_mafalda_of_portugal_virgins: 'Santas Sancha e Mafalda de Portugal, virgens',
    scholastica_of_nursia_virgin: 'Santa Escolástica, virgem',
    sebastian_of_milan_martyr: 'São Sebastião, mártir',
    seven_holy_founders_of_the_servite_order: 'Sete Fundadores dos Servitas',
    sharbel_makhluf_priest: 'São Charbel Makhluf, sacerdote e monge',
    simon_and_jude_apostles: 'São Simão e São Judas Tadeu, apóstolos',
    ...
    stephen_the_first_martyr: 'Santo Estêvão, protomártir',
    ...
    teresa_benedicta_of_the_cross_stein_virgin: 'Santa Teresa Benedita da Cruz Stein, virgem e mártir',
    teresa_of_jesus_of_avila_virgin: 'Santa Teresa de Jesus de Ávila, virgem e doutora da Igreja',
    teresa_of_portugal_religious: 'Beata Teresa de Portugal, religiosa',
    theotonius_of_coimbra_priest: 'Santo Teotónio de Coimbra, sacerdote',
    ...
    thomas_aquinas_priest: 'São Tomás de Aquino, sacerdote e doutor da Igreja',
    ...
    timothy_of_ephesus_and_titus_of_crete_bishops: 'São Timóteo e São Tito, bispos',
    ...
    turibius_of_mogrovejo_bishop: 'Santo Turíbio de Mongrovejo, bispo',
    urban_i_pope: 'Papa São Urbano I',
    valerius_of_trier_bishop: 'São Valério, bispo',
    vincent_de_paul_priest: 'São Vicente de Paulo, sacerdote',
    vincent_ferrer_priest: 'São Vicente Ferrer, sacerdote',
    vincent_of_saragossa_deacon: 'São Vicente de Saragoça, diácono',
    visitation_of_mary: 'Visitação de Nossa Senhora',
