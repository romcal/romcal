...
export enum PatronTitle {
  ...
  PatronOfNorthAfrica = 'PATRON_OF_NORTH_AFRICA',
  ...
  PatronOfTheApostolicVicariate = 'PATRON_OF_THE_APOSTOLIC_VICARIATE',
  ...
  PatronessOfTheApostolicVicariate = 'PATRONESS_OF_THE_APOSTOLIC_VICARIATE',
  PatronessOfTheArchdiocese = 'PATRONESS_OF_THE_ARCHDIOCESE',
