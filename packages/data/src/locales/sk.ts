...
export const locale: Locale = {
  ...
  names: {
    ...
    divine_mercy_sunday: '{{week}}. veľkonočná nedeľa alebo Nedeľa Božieho milosrdenstva',
    ...
    sunday_of_the_word_of_god: '{{week}}. nedeľa v Cezročnom období, alebo Nedeľa Božieho slova',
