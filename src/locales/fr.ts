...
export default {
  ...
  sanctoral: {
    ...
    joachim_and_anne_principal_patroness_of_the_province_of_quebec_parents_of_mary: 'Saints Anne, Patronne de la province civile de Québec, et Joachim, Parents de la Vierge Marie (1er siècle)',
    ...
    joan_of_arc_virgin_secondary_patroness_of_france: 'Sainte Jeanne d’Arc, Vierge, Patronne Secondaire de la France (✝ 1431)',
    ...
    joseph_spouse_of_mary_principal_patron_of_canada: 'Saint Joseph, Époux de la Bienheureuse Vierge Marie, Patron du Canada',
    ...
    our_lady_of_sorrows_principal_patroness_of_slovakia: 'Notre-Dame des Douleurs, Patronne de la Slovaquie',
    george_of_lydda_martyr_principal_patron_of_england: 'Saint Georges, Martyr et Patron de l’Angleterre (✝ 303)',
    benedict_of_nursia_abbot_principal_patron_of_europe: 'Saint Benoît de Nursie, Patriarche des moines d’Occident, Fondateur de l’ordre des Bénédictins et Patron de l’Europe (✝ v. 547)',
    ...
    andrew_apostle_principal_patron_of_scotland: 'Saint André, Apôtre et Patron de l’Écosse',
    ...
    catherine_of_siena_virgin_secondary_patroness_of_europe: 'Sainte Catherine de Sienne, Vierge, Docteur de l’Eglise, Copatronne de l’Europe (✝ 1380)',
    ...
    patrick_of_ireland_bishop_principal_patron_of_ireland: 'Saint Patrick, Évêque, Patron de l’Irlande (✝ 461)',
    columba_of_iona_abbot_secondary_patron_of_ireland: 'Saint Colomba, Religieux, Patron Secondaire de l’Irlande (✝ 615)',
    our_lady_of_guadalupe_principal_patroness_of_the_americas: 'Notre-Dame de Guadalupe, Patronne des Amériques',
