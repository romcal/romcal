...
export const locale: Locale = {
  ...
  seasons: {
    advent: {
      ...
      weekday: '$t(weekdays:{{dow}}) της $t(ordinals:{{week}}, { "context": "ordinal" }) Εβδομάδας της Παρουσίας',
    ...
    lent: {
      ...
      weekday: '$t(weekdays:{{dow}}) της $t(ordinals:{{week}}, { "context": "ordinal" }) Εβδομάδας της Τεσσαρακοστής',
    ...
    paschal_triduum: {
      season: 'Πασχαλινό τριήμερο',
    },

    easter_time: {
      season: 'Περίοδος του Πάσχα',
      weekday: '$t(weekdays:{{dow}}) της $t(ordinals:{{week}}, { "context": "ordinal" }) Εβδομάδας του Πάσχα',
      sunday: '$t(ordinals:{{week}}) Κυριακή της Πάσχα',
  ...
  names: {
    ...
    our_lady_of_faneromeni: 'Υπεραγίας Θεοτόκου της Φανερωμένης',
