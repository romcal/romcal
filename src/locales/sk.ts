...
export default {
  ...
  sanctoral: {
    ...
    our_lady_mother_of_divine_providence_principal_patroness_of_puerto_rico: 'Panny Márie, Matky Božej Prozreteľnosti a hlavnej patrónky Portorika',
    our_lady_mother_of_mercy: 'Panny Márie Ostrobramskej',
    our_lady_of_aparecida_principal_patroness_of_brazil: 'Panny Márie z Aparecidy, hlavnej patrónky Brazílie',
    ...
    our_lady_of_guadalupe_principal_patroness_of_the_philippines: 'Preblahoslavenej Panny Márie Guadalupskej, hlavnej patrónky Filipín',
    our_lady_of_hungary_principal_patroness_of_hungary: 'Panny Márie Maďarov, hlavnej patrónky Maďarov',
    ...
    our_lady_of_lujan_principal_patroness_of_argentina: 'Panny Marie Lujánska, hlavnej patrónky Argentíny',
    ...
    andrew_apostle_principal_patron_of_russia: 'Svätého Ondreja, apoštola a hlavného patróna Ruska',
    angela_merici_virgin: 'Svätej Angely Merici, panny',
    joachim_and_anne_principal_patroness_of_the_province_of_quebec_parents_of_mary: 'Svätých Anny, hlavnej patrónky Quebecu a Joachima, rodičov Panny Márie',
    ...
    brigid_of_kildare_virgin_secondary_patron_of_ireland: 'Svätej Brigity Írskej, panny a spolupatrónky Írska',
    ...
    james_apostle_principal_patron_of_spain: 'Svätého Jakuba, apoštola a hlavného patróna Španielska',
    ...
    joan_of_arc_virgin_secondary_patroness_of_france: 'Svätej Jany z Arku, panny a spolupatrónky Francúzska',
    ...
    rose_of_lima_virgin_secondary_patroness_of_the_philippines: 'Svätej Ruženy Limskej, panny a spolupatrónky Filipín',
    ...
    john_de_brebeuf_isaac_jogues_priests_and_companions_martyrs_secondary_patrons_of_canada: 'Svätých Jána de Brébeuf a Izáka Joguesa, kňazov a spoločníkov, mučeníkov, spolupatrónov Kanady',
    ...
    therese_of_the_child_jesus_and_the_holy_face_of_lisieux_virgin_secondary_patroness_of_france: 'Svätej Terézie od Dieťaťa Ježiša a Svätej tváre z Lisieux, panny, učiteľky Cirkvi a spolupatrónky Francúzska',
    ...
    immaculate_conception_of_mary_principal_patroness_of_the_usa: 'Nepoškvrnené počatie Panny Márie, hlavnej patrónky USA',
    peter_chanel_priest_principal_patron_of_oceania: 'Svätého Petra Chanela, prvého mučeníka Oceánie a hlavného patróna Oceánie',
    ...
    our_lady_of_sorrows_principal_patroness_of_slovakia: 'Sedembolestnej Panny Márie, hlavnej patrónky Slovenska',
    george_of_lydda_martyr_principal_patron_of_england: 'Svätého Juraja, mučeníka a hlavného patróna Anglicka',
    benedict_of_nursia_abbot_principal_patron_of_europe: 'Svätého Benedikta, opáta a hlavného patróna Európy',
    cyril_the_philosopher_monk_and_methodius_of_thessaloniki_bishop_secondary_patrons_of_europe: 'Svätých Cyrila, mnícha a Metoda, biskupa, patrónov Európy',
    ...
    teresa_benedicta_of_the_cross_stein_virgin_secondary_patron_of_europe: 'Svätej Terézie Benedikty z Kríža Steinovej, panny, mučenice a spolupatrónky Európy',
    andrew_apostle_principal_patron_of_scotland: 'Svätého Ondreja, apoštola a hlavného patróna Škótska',
    david_of_wales_bishop_principal_patron_of_wales: 'Svätého Dávida z Walesu, biskupa a hlavného patróna Walesu',
    bridget_of_sweden_religious_secondary_patroness_of_europe: 'Svätej Brigity, rehoľnice a spolupatrónky Európy',
    catherine_of_siena_virgin_secondary_patroness_of_europe: 'Svätej Kataríny Sienskej, panny, učiteľky Cirkvi a spolupatrónky Európy',
    catherine_of_siena_virgin_secondary_patroness_of_italy_and_europe: 'Svätej Kataríny Sienskej, panny, učiteľky Cirkvi a spolupatrónky Talianska a Európy',
    patrick_of_ireland_bishop_principal_patron_of_ireland: 'Svätého Patrika, biskupa a hlavného patróna Írska',
    columba_of_iona_abbot_secondary_patron_of_ireland: 'Svätého Kolumbu, opáta a spolupatróna Írska',
    our_lady_of_guadalupe_principal_patroness_of_the_americas: 'Preblahoslavenej Panny Márie Guadalupskej, hlavnej patrónky Ameriky',
    francis_of_assisi_principal_patron_of_italy: 'Svätého Františka Assiského, hlavného patróna Talianska',
  },
} as RomcalLocale;
