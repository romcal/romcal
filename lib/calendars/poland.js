...
module.exports = {
  dates: function() {
    return [
      ...
      {
        "key": "saintJohnSarkanderPriestAndMartyrOrSaintZdzislawa",
        "name": "Saint John Sarkander, Priest and Martyr or Saint Zdzislawa",
        "type": Types[6],
      ...
      // jarosz: Split saintRuizAndCo and saintWenceslaus (they are a single celebration in general.js)
      {
        ...
        "name": "Saints Lawrence Ruiz & Companions, Martyrs",
        "type": Types[6],
