...
export default {
  ...
  sanctoral: {
    ...
    our_lady_of_sorrows_principal_patroness_of_slovakia: 'Beata Vergine Maria Addolorata, patrona principale della Slovacchia',
    george_of_lydda_martyr_principal_patron_of_england: 'San Giorgio, martire e patrono principale d’Inghilterra',
    benedict_of_nursia_abbot_principal_patron_of_europe: 'San Benedetto, abate e patrono principale d’Europa',
    cyril_the_philosopher_monk_and_methodius_of_thessaloniki_bishop_secondary_patrons_of_europe: 'Santi Cirillo, monaco e Metodio, vescovo, patroni d’Europa',
