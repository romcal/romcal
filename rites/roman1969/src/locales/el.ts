...
export const locale: Locale = {
  ...
  names: {
    ...
    andrew_kim_tae_gon_priest_paul_chong_ha_sang_and_companions_martyrs:
      'Αγίου Ανδρέα Kim Tae-gon, πρεσβυτέρου; Αγίου Παύλου Chong Ha-sang, και συντρόφων, μαρτύρων', // src: mr_el_2006_ed3, Γενικό Ρωμαϊκό εορτολόγιο, Σεπτέμβριος, p39
    ...
    augustine_zhao_rong_priest_and_companions_martyrs:
      'Αγίου Αυγουστίνου Zhao Rong, πρεσβυτέρου, και συντρόφων μαρτύρων', // src: mr_el_2006_ed3, Γενικό Ρωμαϊκό εορτολόγιο, Ιούλιος, p37
    ...
    christopher_magallanes_priest_and_companions_martyrs:
      'Αγίου Χριστοφόρου Magallanes, πρεσβυτέρου, και συντρόφων, μαρτύρων', // src: mr_el_2006_ed3, Γενικό Ρωμαϊκό εορτολόγιο, Μάϊος, p35
    ...
    cornelius_i_pope_and_cyprian_of_carthage_bishop_martyrs:
      'Αγίων Κορνηλίου, Πάπα, και Κυπριανού, επισκόπου, μαρτύρων', // src: mr_el_2006_ed3, Γενικό Ρωμαϊκό εορτολόγιο, Σεπτέμβριος, p39
    ...
    dedication_of_the_basilicas_of_saints_peter_and_paul_apostles:
      'Εγκαίνια των Βασιλικών των Αγίων Πέτρου και Παύλου, αποστόλων', // src: mr_el_2006_ed3, Γενικό Ρωμαϊκό εορτολόγιο, Νοέμβριος, p41
    dedication_of_the_cathedral_of_saint_dionysius_athens:
      'Επέτειος των εγκαινίων του Καθεδρικού Ιερού Ναού αγίου Διονυσίου',
    dedication_of_the_lateran_basilica: 'Εγκαίνια της Βασιλικής του Λατερανού', // src: mr_el_2006_ed3, Γενικό Ρωμαϊκό εορτολόγιο, Νοέμβριος, p41
    ...
    john_de_brebeuf_isaac_jogues_priests_and_companions_martyrs:
      'Αγίων Ιωάννη de Brebeuf και Ισαάκ Jogues, πρεσβυτέρων και συντρόφων, μαρτύρων', // src: mr_el_2006_ed3, Γενικό Ρωμαϊκό εορτολόγιο, Οκτώβριος, p40
    ...
    teresa_benedicta_of_the_cross_stein_virgin:
      'Αγίας Θηρεσίας Βενεδίκτης a Cruce (Edith Stein), παρθένου και μάρτυρος', // based on: mr_el_2006_ed3, Γενικό Ρωμαϊκό εορτολόγιο, Αύγουστος, p38
    teresa_benedicta_of_the_cross_stein_virgin_copatroness_of_europe:
      'Αγίας Θηρεσίας Βενεδίκτης a Cruce (Edith Stein), παρθένου και μάρτυρος, προστάτιδας της Ευρώπης', // src: mr_el_2006_ed3, Γενικό Ρωμαϊκό εορτολόγιο, Αύγουστος, p38
    ...
    therese_of_the_child_jesus_and_the_holy_face_of_lisieux_virgin:
      'Αγίας Θηρεσίας του Βρέφους Ιησού, παρθένου και διδασκάλου της Εκκλησίας', // src: mr_el_2006_ed3, Γενικό Ρωμαϊκό εορτολόγιο, Οκτώβριος, p40
