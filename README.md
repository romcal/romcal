...
* 1.2.3 *Fix issue where national feasts appear more than once in the calendar output*
* 1.2.2 *Merge PRs containing bug fixes and improvements*
* 1.2.1 *Added caching mechanism for common celebration dates in the liturgical calendar to improve calendar processing output performance. Added more titles metadata to national and general celebrations.*
