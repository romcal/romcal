...
export default {
  ...
  sanctoral: {
    ...
    saint_adalbert_bishop: 'Saint Adalbert, Évêque de Prague et Martyr (✝ 997)',
    saint_agatha_of_sicily_virgin: 'Sainte Agathe, Vierge et Martyre en Sicile (✝ 251)',
    saint_agnes_of_rome_virgin: 'Sainte Agnès, Vierge et Martyre (✝ v. 304)',
