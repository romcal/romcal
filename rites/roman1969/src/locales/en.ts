...
export const locale: Locale = {
  ...
  names: {
    ...
    paterne_of_avranches_bishop_and_scubilion_abbot: 'Saint Paternus, Bishop, and Scubilion, Abbot',
    ...
    rumpharius_of_coutances_bishop: 'Saint Rumpharius, Bishop of Coutances',
