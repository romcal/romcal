...
## Revisions
* 1.1.5 *Added query to get dates grouped by weeks within their respective months*
...
* `weeksByMonthGrouped`
    - Returns all dates in the year grouped by weeks within their respective months
* `liturgicalYear`
