...
Make sure to use a fixed version in production like https://unpkg.com/romcal@3.0.0-dev.1/dist/cjs/romcal.js as passing no version will redirect to the latest version which might contain breaking changes in the future.
...
<script src="https://unpkg.com/romcal@3.0.0-dev.1/dist/iife/romcal.js"></script>
<script src="https://unpkg.com/@romcal/calendar.france@3.0.0-dev.1/iife/fr.js"></script>
```
