...
export default {
  ...
  sanctoral: {
    ...
    our_lady_mother_of_divine_providence_principal_patroness_of_puerto_rico: 'B. Mariæ Virginis Divinæ Providentiæ Matris atque Patronæ principalis Portus Dives',
    our_lady_mother_of_mercy: 'B. Mariæ Virginis Misericordiæ Matris',
    our_lady_of_aparecida_principal_patroness_of_brazil: 'B. Mariæ Virginis de Aparecida, Patronæ principalis Brasiliæ',
    ...
    our_lady_of_guadalupe_principal_patroness_of_the_philippines: 'Beatæ Mariæ Virginis de Guadalupe, Patronæ principalis Insularum Philippinarum',
    our_lady_of_hungary_principal_patroness_of_hungary: 'B. Mariæ Virginis, Patronæ principalis Hungariæ',
    ...
    our_lady_of_lujan_principal_patroness_of_argentina: 'B. Mariæ Virginis de Luján, Patronæ principalis Argentinæ',
    ...
    andrew_apostle_principal_patron_of_russia: 'S. Andreæ, apostoli et patroni principalis Russiæ',
    angela_merici_virgin: 'S. Angelæ Merici, virginis',
    joachim_and_anne_principal_patroness_of_the_province_of_quebec_parents_of_mary: 'S. Annæ, patronæ principalis Quebeci, et S. Ioachim, parentum B. M. V.',
    ...
    brigid_of_kildare_virgin_secondary_patron_of_ireland: 'S. Brigidæ, virginis et patronæ secundariæ Hiberniæ',
    ...
    james_apostle_principal_patron_of_spain: 'S. Iacobi, apostoli et patroni principalis Hispaniæ',
    ...
    thomas_hioji_rokuzayemon_nishi_priest_and_companions_martyrs: 'Ss. Thomæ Hioji Rokuzayemon Nishi, presbyteri, et sociorum, martyrum',
    ...
    ulrich_of_augsburg_bishop: 'S. Udalrici, episcopi',
    ...
    seven_martyred_nuns_from_the_franciscan_missionaries_of_mary: 'Ss. septem sorores ex Instituto Franciscanum Missionariarum Mariæ, martyrum',
    ...
    translation_of_the_relics_of_saint_stephen_of_hungary: 'In Translationis de reliquiis S. Stephani Hungariæ',
    vietnamese_martyrs: 'Ss. Martyrum Vietnamicæ',
    ...
    immaculate_conception_of_mary_principal_patroness_of_the_usa: 'In Conceptione Immaculata Beatæ Mariæ Virginis, Patronæ principalis Civitatum Fœderatæ Americæ',
    peter_chanel_priest_principal_patron_of_oceania: 'S. Petri Chanel, protomartyris Oceaniæ et patroni principalis Oceaniæ',
    ...
    our_lady_of_sorrows_principal_patroness_of_slovakia: 'B. Mariæ Virginis Perdolentis, Patronæ principalis Slovaciæ',
    george_of_lydda_martyr_principal_patron_of_england: 'S. Georgii, martyris et patroni principalis Angliæ',
    benedict_of_nursia_abbot_principal_patron_of_europe: 'S. Benedicti, abbatis et patroni principalis Europæ',
    cyril_the_philosopher_monk_and_methodius_of_thessaloniki_bishop_secondary_patrons_of_europe: 'Ss. Cyrilli, monachi, et Methodii, episcopi, patronorum Europæ',
    cyril_the_philosopher_monk_and_methodius_of_thessaloniki_bishop_slavic_missionaries: 'Ss. Cyrilli et Methodii, missionariorum Slavorum',
    teresa_benedicta_of_the_cross_stein_virgin_secondary_patron_of_europe: 'S. Teresiæ Benedictæ a Cruce Stein, virginis, martyris et patronæ secundariæ Europæ',
    ...
    our_lady_of_guadalupe_principal_patroness_of_the_americas: 'B. Mariæ Virginis de Guadalupe, Patronæ principalis Americæ',
    francis_of_assisi_principal_patron_of_italy: 'S. Francisci Assisiensis, patroni principalis Italiæ',
  },
} as RomcalLocale;
