...
export const locale: Locale = {
  ...
  names: {
    ...
    alain_de_solminihac_bishop: 'Blessed Alain de Solminihac, Bishop',
    alain_of_lavaur: 'Saint Alain of Lavaur',
    ...
    alithe_of_cahors_bishop: 'Saint Alithe of Cahors, Bishop',
    ...
    all_saints_of_the_diocese_of_beauvais_noyon_and_senlis: 'All Saints of the Diocesan Church',
    ...
    alypius_of_thagaste_and_possidius_of_calama_bishops: 'Saints Alypius and Possidius, Bishops',
    alypius_of_thagaste_bishop: 'Saint Alypius, Bishop',
    ...
    anastasius_the_venetian_monk: 'Saint Anastasius the Venetian, Monk',
    andre_bessette_religious: 'Saint André Bessette, Religious',
    andre_grasset_priest: 'Blessed André Grasset, Priest and Martyr',
    andre_parsy_and_louis_didion_martyrs: 'Blessed André Parsy and Louis Didion, Martyrs',
    andre_parsy_martyr: 'Blessed André Parsy, Martyr',
    ...
    andrew_hubert_fournet_priest: 'Saint Andrew-Hubert Fournet, Priest',
    ...
    angadrisma_of_beauvais_abbess: 'Saint Angadrisma of Beauvais, Abbess and Virgin',
    angadrisma_of_beauvais_abbess_principal_patroness_of_beauvais_and_secondary_patroness_of_the_diocese:
      'Saint Angadrisma, Principal Patroness of Beauvais and Secondary Patroness of the Diocese',
    ...
    annette_pelras_virgin_and_companions_martyrs:
      'Saint Annette Pelras (Marie-Henriette of Providence) and Companions, Carmelite Martyrs of Compiègne',
    ...
    anthony_of_lialores_hermit: 'Saint Anthony of Lialores, Hermit and Martyr',
    ...
    antoine_charles_du_bouzet_bertrand_antoine_de_caupenne_priests_and_companions_martyrs:
      'Blesseds Antoine-Charles du Bouzet and Bertrand-Antoine de Caupenne, Priests, and Companions, Martyrs',
    antoine_charles_du_bouzet_priest: 'Blessed Antoine-Charles du Bouzet, Priest and Martyr',
    ...
    antonin_of_pamiers_martyr_principal_patron_of_the_diocese_of_pamiers:
      'Saint Antonin of Pamiers, Martyr, Titular of the Cathedral and Principal Patron of the Diocese',
    ...
    basilissa_of_antioch_virgin: 'Saint Basilissa of Antioch, Virgin',
    ...
    berard_of_carbio_and_companions_martyrs: 'Saint Berard and Companions, Martyrs',
    berard_of_carbio_and_companions_martyrs_patrons_of_the_archdiocese_of_rabat:
      'Saint Berard and Companions, Martyrs, Patrons of the Archdiocese of Rabat',
    berard_of_carbio_priest: 'Saint Berard of Carbio, Priest and Martyr',
    berenger_of_saint_papoul_monk: 'Saint Bérenger of Saint-Papoul, Monk',
    ...
    calais_of_anisole_abbot: 'Saint Calais of Anisole, Abbot', // src: mr_fr_1998_ed1_laval
    calais_of_anisole_and_siviard_of_anisole_abbots: 'Saints Calais and Siviard, Abbots', // src: mr_fr_1998_ed1_laval
    ...
    cecilia_of_rome_virgin_principal_patroness_of_the_archdiocese_of_albi:
      'Saint Cecilia, Virgin and Martyr, Titular of the Cathedral and Principal Patroness of the Archdiocese of Albi',
    ceferino_gimenez_malla_martyr: 'Blessed Ceferino Giménez Malla, Martyr',
    celerina_of_carthage_and_companions_martyrs: 'Saint Celerina and Companions, Martyrs',
    celerina_of_carthage_martyr: 'Saint Celerina of Carthage, Martyr',
    celsus_of_milan_martyr: 'Saint Celsus of Milan, Martyr',
    cenere_of_saulges_hermit: 'Saint Céneré of Saulges, Hermit', // src: mr_fr_1998_ed1_laval
    cerase_of_simorre_bishop: 'Saint Cérase of Simorre, Bishop',
    ...
    charles_carnus_priest: 'Blessed Charles Carnus, Priest and Martyr',
    charles_collas_du_bignon_priest_martyr: 'Blessed Charles Collas du Bignon, Priest and Martyr', // src: mr_fr_1998_ed1_laval
    ...
    charles_of_blois: 'Blessed Charles of Blois', // src: mr_fr_1998_ed1_laval
    ...
    christopher_of_romandiola_priest: 'Blessed Christopher of Romandiola, Priest',
    chrysolius_martyr: 'Saint Chrysolius, Martyr',
    ciaran_of_clonmacnoise_abbot: 'Saint Ciaran, Abbot',
    cibar_of_saint_ybars_monk: 'Saint Cibar of Saint-Ybars, Monk',
    clair_of_lectoure_martyr: 'Saint Clair of Lectoure, Martyr',
    ...
    claude_caix_charles_carnus_jean_lacan_jean_antoine_segonds_pierre_jean_garrigues_priests_and_companions_martyrs:
      'Blesseds Claude Caïx, Charles Carnus, Jean Lacan, Jean-Antoine Segonds and Pierre-Jean Garrigues, Priests, and Companions, Martyrs',
    claude_caix_priest: 'Blessed Claude Caïx, Priest and Martyr',
    ...
    cornelius_i_pope: 'Saint Cornelius, Pope and Martyr',
    ...
    crispina_of_thagora_martyr: 'Saint Crispina, Martyr',
    cuthbert_of_lindisfarne_bishop: 'Saint Cuthbert, Bishop',
    cyprian_of_carthage_bishop: 'Saint Cyprian, Bishop and Martyr',
    cyprian_of_carthage_bishop_patron_of_north_africa: 'Saint Cyprian, Bishop and Martyr, Patron of North Africa',
    ...
    dedication_of_the_cathedral_of_algiers_algeria: 'The Dedication of the Cathedral of Algiers, Algeria',
    ...
    dedication_of_the_cathedral_of_saint_michael_carcassonne_france:
      'The Dedication of the Cathedral of Saint Michael, Carcassonne, France',
    ...
    dedication_of_the_cathedral_of_the_holy_trinity_laval_france:
      'The Dedication of the Cathedral of the Holy Trinity, Laval', // src: mr_fr_1998_ed1_laval
    ...
    dedication_of_the_cathedral_of_tripoli_libya: 'The Dedication of the Cathedral of Tripoli, Libya',
    dedication_of_the_cathedral_of_tunis_tunisia: 'The Dedication of the Cathedral of Tunis, Tunisia',
    ...
    deogratias_of_carthage_bishop: 'Saint Deogratias of Carthage, Bishop',
    ...
    eleutherius_of_tournai_bishop: 'Saint Eleutherius of Tournai, Bishop',
    ...
    elizabeth_bichier_des_ages_virgin: 'Saint Elizabeth Bichier des Ages, Virgin',
    ...
    everard_of_friuli: 'Saint Everard of Friuli',
    evroult_of_saint_lucien_abbot: 'Saint Evroult, Abbot of Saint-Lucien',
    ...
    fleur_of_issendolus_virgin: 'Saint Fleur of Issendolus, Virgin',
    florent_dumontet_de_cardaillac_priest: 'Blessed Florent Dumontet de Cardaillac, Priest and Martyr',
    florent_of_cahors_alithe_of_cahors_urcisse_of_cahors_bishops_and_all_holy_bishops_of_the_diocese_of_cahors:
      'Saints Florent, Alithe and Urcisse, Bishops, and All Holy Bishops of Cahors',
    florent_of_cahors_bishop: 'Saint Florent of Cahors, Bishop',
    ...
    folquin_of_therouanne_bishop: 'Saint Folquin, Bishop',
    ...
    francis_of_assisi_patron_of_the_apostolic_vicariate_of_tripoli:
      'Saint Francis of Assisi, Patron of the Apostolic Vicariate of Tripoli',
    ...
    francois_joseph_de_la_rochefoucauld_bishop: 'Blessed François-Joseph de La Rochefoucauld, Bishop and Martyr',
    francois_joseph_de_la_rochefoucauld_bishop_and_companions_martyrs:
      'Blessed François-Joseph de La Rochefoucauld, Bishop, and Companions, Martyrs',
    ...
    fulgentius_of_ruspe_bishop: 'Saint Fulgentius, Bishop',
    ...
    galactorius_of_lescar_bishop_and_martyr: 'Saint Galactorius of Lescar, Bishop and Martyr',
    ...
    gelasius_i_pope: 'Saint Gelasius I, Pope',
    ...
    germer_of_fly_abbot: 'Saint Germer of Fly, Abbot',
    germer_of_fly_abbot_and_holy_abbots_of_fly: 'Saint Germer and the Holy Abbots of Fly',
    ...
    gimer_of_carcassonne_bishop: 'Saint Gimer of Carcassonne, Bishop',
    ...
    godeberta_of_noyon_virgin: 'Saint Godeberta of Noyon, Virgin',
    gorazd_of_moravia_and_companions: 'Saint Gorazd and Companions',
    gotthard_of_hildesheim_bishop: 'Saint Gotthard, Bishop',
    grat_of_oloron_bishop: 'Saint Grat of Oloron, Bishop, Patron of the City of Oloron',
    ...
    holy_abbots_of_fly: 'Holy Abbots of Fly',
    holy_bishops_of_le_mans: 'The Holy Bishops of Le Mans', // src: mr_fr_1998_ed1_laval
    ...
    immaculate_conception_of_the_blessed_virgin_mary_patroness_of_the_archdiocese_of_tangier:
      'The Immaculate Conception of the Blessed Virgin Mary, Patroness of the Archdiocese of Tangier',
    ...
    ivo_of_auteuil_bishop: 'Saint Ivo of Auteuil, Bishop',
    ivo_of_chartres_bishop: 'Saint Ivo of Chartres, Bishop',
    ...
    jacques_ledoyen_priest_and_companions_martyrs: 'Blessed Jacques Ledoyen, Priest, and Companions, Martyrs', // src: mr_fr_1998_ed1_laval
    jacques_ledoyen_priest_martyr: 'Blessed Jacques Ledoyen, Priest and Martyr', // src: mr_fr_1998_ed1_laval
    james_apostle: 'Saint James, Apostle',
    james_apostle_patron_of_spain: 'Saint James, Apostle, Patron of Spain',
    james_of_lambaesis_deacon: 'Saint James of Lambaesis, Deacon and Martyr',
    james_of_lambaesis_deacon_marian_of_lambaesis_lector_and_companions_martyrs:
      'Saints James, Deacon, Marian, Lector, and Companions, Martyrs',
    ...
    jean_de_mayorga_religious_and_companions_martyrs: 'Blessed Jean de Mayorga, Religious, and Companions, Martyrs',
    jean_francois_bonnel_de_pradal_priest: 'Blessed Jean-François Bonnel de Pradal, Priest and Martyr',
    jean_francois_bousquet_priest: 'Blessed Jean-François Bousquet, Priest and Martyr',
    jean_francois_bousquet_priest_and_companions_martyrs:
      'Blessed Jean-François Bousquet, Priest, and Companions, Martyrs',
    ...
    jean_turpin_du_cormier_priest_and_companions_martyrs:
      'Blessed Jean Turpin du Cormier, Priest, and Companions, Martyrs', // src: mr_fr_1998_ed1_laval
    jeanne_delanoue_of_the_cross_religious: 'Saint Jeanne Delanoue, Religious', // mr_fr_2022_ed3_angers
    jeanne_emilie_de_villeneuve_virgin: 'Saint Jeanne-Émilie de Villeneuve, Virgin',
    jeanne_jugan_virgin: 'Saint Jeanne Jugan, Virgin', // src: https://diocesedelaval.fr/le-propre-du-diocese-de-laval/
    ...
    john_henry_newman_priest: 'Saint John Henry Newman, Priest and Doctor of the Church',
    ...
    john_of_warneton_bishop: 'Blessed John of Warneton, Bishop',
    ...
    joseph_henri_chamayou_religious: 'Blessed Joseph-Henri Chamayou, Religious and Martyr',
    joseph_louis_marcou_and_joseph_henri_chamayou_religious_martyrs:
      'Blesseds Joseph Louis Marcou (Brother Louis de Jésus) and Henri Chamayou (Brother Jacob Samuel), Religious and Martyrs',
    joseph_louis_marcou_religious: 'Blessed Joseph-Louis Marcou, Religious and Martyr',
    joseph_marie_cassant_priest: 'Blessed Joseph-Marie Cassant, Priest',
    ...
    julian_of_antioch_and_basilissa_of_antioch_martyrs: 'Saints Julian and Basilissa, Martyrs',
    julian_of_antioch_martyr: 'Saint Julian of Antioch, Martyr',
    julian_of_beauvais_martyr: 'Saint Julian of Beauvais, Martyr',
    julian_of_le_mans_bishop: 'Saint Julian of Le Mans, Bishop', // src: mr_fr_1998_ed1_laval
    julian_of_le_mans_bishop_second_patron_of_the_diocese_of_laval:
      'Saint Julian, First Bishop of Le Mans, Second Patron of the Diocese of Laval', // src: mr_fr_1998_ed1_laval
    julian_of_lescar_bishop: 'Saint Julian of Lescar, Bishop, Patron of the City of Lescar',
    ...
    justus_of_alcala_and_pastor_of_alcala_martyrs: 'Saints Justus and Pastor, Martyrs',
    justus_of_alcala_martyr: 'Saint Justus of Alcalá, Martyr',
    ...
    lizier_of_couserans_bishop: 'Saint Lizier of Couserans, Bishop',
    longinus_of_pomaria_bishop: 'Saint Longinus of Pomaria, Bishop',
    longinus_of_pomaria_eugenius_of_carthage_and_vindemialis_of_capsa_bishops:
      'Saints Longinus, Eugenius and Vindemialis, Bishops',
    louis_antoine_ormieres_priest: 'Blessed Louis-Antoine Ormières, Priest',
    louis_bertrand_priest: 'Saint Louis Bertrand, Priest',
    louis_didion_martyr: 'Blessed Louis Didion, Martyr',
    louis_edouard_cestac_priest: 'Blessed Louis-Édouard Cestac, Priest',
    ...
    luperc_of_eauze_martyr: 'Saint Luperc of Eauze, Martyr',
    ...
    majan_of_lombez: 'Saint Majan of Lombez',
    ...
    marcellinus_of_carthage_martyr: 'Saint Marcellinus of Carthage, Martyr',
    ...
    marcellus_of_tangier_and_maximilian_of_tebessa_martyrs: 'Saints Marcellus and Maximilian, Martyrs',
    marcellus_of_tangier_martyr: 'Saint Marcellus of Tangier, Martyr',
    marciana_of_mauretania_virgin: 'Saint Marciana, Virgin and Martyr',
    ...
    margaret_of_lorraine_religious: 'Blessed Margaret of Lorraine, Widow and Religious', // src: mr_fr_1998_ed1_laval
    ...
    marian_of_lambaesis_lector: 'Saint Marian of Lambaesis, Lector and Martyr',
    ...
    martiana_of_albi_virgin: 'Saint Martiana of Albi, Virgin',
    ...
    michael_gabriel_and_raphael_archangels_michael_principal_patron_of_the_diocese_of_carcassonne_and_narbonne:
      'Saints Michael, Gabriel and Raphael, Archangels; Saint Michael, Principal Patron of the Diocese of Carcassonne and Narbonne',
    ...
    miltiades_i_pope: 'Saint Miltiades, Pope',
    ...
    momelin_of_noyon_bishop: 'Saint Momelin, Bishop',
    monica_of_hippo: 'Saint Monica',
    monica_of_hippo_mother_of_a_family: 'Saint Monica, Mother of a Family',
    ...
    nazarius_of_milan_and_celsus_of_milan_martyrs_patrons_of_the_diocese_of_carcassonne_and_narbonne:
      'Saints Nazarius and Celsus, Martyrs and Patrons of the Diocese of Carcassonne and Narbonne',
    nazarius_of_milan_martyr: 'Saint Nazarius of Milan, Martyr',
    nemesianus_of_thubunae_and_companions_martyrs: 'Saint Nemesianus and Companions, Martyrs',
    nemesianus_of_thubunae_bishop: 'Saint Nemesianus of Thubunae, Bishop and Martyr',
    ...
    optatus_of_milevis_bishop: 'Saint Optatus, Bishop',
     ...
     */
    our_lady_of_africa: 'Our Lady of Africa',
    ...
    our_lady_of_carthage: 'Our Lady of Carthage',
    ...
    our_lady_of_the_dunes: 'Our Lady of the Dunes',
    ...
    our_lady_of_the_treille: 'Our Lady of the Treille',
    our_lady_of_the_treille_patroness_of_the_archdiocese_of_lille:
      'Our Lady of the Treille, Patroness of the Archdiocese of Lille',
    ...
    ours_of_cahors_abbot: 'Saint Ours of Cahors, Abbot',
    ...
    papoul_of_lauragais_priest: 'Saint Papoul of Lauragais, Priest and Martyr',
    ...
    pastor_of_alcala_martyr: 'Saint Pastor of Alcalá, Martyr',
    ...
    paul_denn_and_remy_isore_priests_martyrs: 'Saints Paul Denn and Rémy Isoré, Priests and Martyrs',
    paul_denn_priest: 'Saint Paul Denn, Priest and Martyr',
    ...
    perpetua_of_carthage_and_felicity_of_carthage_and_companions_martyrs:
      'Saints Perpetua and Felicity and Companions, Martyrs',
    ...
    piatus_of_seclin_martyr: 'Saint Piatus, Missionary and Martyr',
    pierre_claverie_bishop: 'Blessed Pierre Claverie, Bishop and Martyr',
    pierre_claverie_bishop_and_companions_religious_martyrs:
      'Blessed Pierre Claverie, Bishop, and Companions, Religious and Martyrs',
    ...
    possidius_of_calama_bishop: 'Saint Possidius of Calama, Bishop',
    ...
    quodvultdeus_of_carthage_and_deogratias_of_carthage_bishops: 'Saints Quodvultdeus and Deogratias, Bishops',
    quodvultdeus_of_carthage_bishop: 'Saint Quodvultdeus of Carthage, Bishop',
    ...
    raoul_de_la_futaie_priest: 'Blessed Raoul de la Futaie, Priest and Hermit', // src: mr_fr_1998_ed1_laval
    ...
    raymond_cayre_priest: 'Blessed Raymond Cayré, Priest and Martyr',
    raymond_cayre_priest_and_companions_martyrs: 'Blessed Raymond Cayré, Priest, and Companions, Martyrs',
    raymond_costeran_and_companions_martyrs: 'Blessed Raymond Escrivan and Companions, Martyrs',
    raymond_costeran_martyr: 'Blessed Raymond Escrivan, Martyr',
    ...
    regulus_of_senlis_bishop: 'Saint Regulus, Bishop of Senlis',
    ...
    remy_isore_priest: 'Saint Rémy Isoré, Priest and Martyr',
    ...
    rusticus_of_narbonne_bishop: 'Saint Rusticus of Narbonne, Bishop',
    ...
    sigolena_of_albi_abbess: 'Saint Sigolena of Albi, Abbess',
    simon_and_jude_apostles: 'Saints Simon and Jude, Apostles',
    simon_of_lipnica_priest: 'Saint Simon of Lipnica, Priest',
    siviard_of_anisole_abbot: 'Saint Siviard of Anisole, Abbot', // src: mr_fr_1998_ed1_laval
    ...
    speratus_of_scillium_and_companions_martyrs: 'Saint Speratus and Companions, Martyrs',
    speratus_of_scillium_martyr: 'Saint Speratus of Scillium, Martyr',
    ...
    stephen_the_first_martyr_and_principal_patron_of_the_diocese_of_cahors:
      'Saint Stephen, the First Martyr, Principal Patron of the Diocese of Cahors',
    ...
    taurin_of_eauze_martyr: 'Saint Taurin of Eauze, Martyr',
    ...
    thomas_rene_dubuisson_priest_martyr: 'Blessed Thomas-René Dubuisson, Priest and Martyr', // src: mr_fr_1998_ed1_laval
    ...
    tugdual_of_treguier_bishop_patron_of_the_city_of_laval:
      'Saint Tugdual, Bishop of Tréguier, Patron of the City of Laval', // src: mr_fr_1998_ed1_laval
    turibius_of_mogrovejo_bishop: 'Saint Turibius of Mogrovejo, Bishop',
    udault_of_ax_priest: 'Saint Udault of Ax, Priest and Martyr',
    ...
    urcisse_of_cahors_bishop: 'Saint Urcisse of Cahors, Bishop',
    ursula_of_cologne_and_companions_virgins: 'Saint Ursula and Companions, Virgins and Martyrs',
    vaast_of_arras_bishop: 'Saint Vaast, Bishop',
    ...
    vincent_de_paul_priest_patron_of_the_priests_of_the_archdiocese_of_albi:
      'Saint Vincent de Paul, Priest, Patron of the Priests of the Archdiocese of Albi',
    ...
    volusian_of_tours_bishop: 'Saint Volusian of Tours, Bishop',
    vulmar_of_samer_abbot: 'Saint Vulmar, Priest, Hermit and Abbot',
    ...
    winnoc_of_wormhout_abbot: 'Saint Winnoc, Abbot',
    ...
    ysarn_of_saint_victor_abbot: 'Saint Ysarn of Saint-Victor, Abbot',
