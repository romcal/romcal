...
export type BaseLiturgicalDayInput = Pick<BaseLiturgicalDay, 'key'> &
  ...
  > & {
    ...
    /**
     * The locale namespace of the liturgical day.
     *
     ...
     * to lookup.
     */
    namespace?: RomcalLiturgicalDayNamespace;
    /**
...
export type DropLiturgicalDayInput = Pick<LiturgicalDayExtendedInput, 'key'> &
  Partial<Omit<LiturgicalDayExtendedInput, 'key'>> & {
    /**
     * If this liturgical day must be removed from this calendar and from all those it inherits,
     * on the final calendar generated by romcal.
     */
 ...
 */
export type LiturgicalDayInput = BaseLiturgicalDayInput | LiturgicalDayExtendedInput | DropLiturgicalDayInput;
 ...
 * The locale namespace of the liturgical day.
 */
export type RomcalLiturgicalDayNamespace =
  | 'temporale'
  | 'advent'
  | 'christmastide'
  | 'epiphany'
