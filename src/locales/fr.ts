...
export default {
  ...
  sanctoral: {
    ...
    joachim_and_anne_principal_patroness_of_the_province_of_quebec_parents_of_mary: 'Saints Anne, Patronne Principale du Québec, et Joachim, Parents de la Vierge Marie (1er siècle)',
    ...
    elizabeth_of_portugal: 'Sainte Elisabeth du Portugal, Reine (✝ 1336)',
    ...
    francois_de_laval_bishop: 'Saint François de Laval, Premier évêque de Québec (✝ 1708)',
    ...
    ignatius_of_antioch_bishop: 'Saint Ignace d’Antioche, Évêque et Martyr, Père et Docteur de l’Eglise (✝ 115)',
    ...
    isidore_of_seville_bishop: 'Saint Isidore de Séville, Docteur de l’Eglise, Évêque et Confesseur (✝ 636)',
    ...
    joan_of_arc_virgin_secondary_patroness_of_france: 'Sainte Jeanne d’Arc, Vierge, Patronne Secondaires de la France (✝ 1431)',
    john_baptist_de_la_salle_priest: 'Saint Jean-Baptiste de La Salle, Prêtre et Fondateur des Frères des Ecoles Chrétiennes (✝ 1719)',
    ...
    john_of_god_religious: 'Saint Jean de Dieu, Religieux, Fondateur des Frères de la Charité (✝ 1550)',
    ...
    joseph_spouse_of_mary_principal_patron_of_canada: 'Saint Joseph, Époux de la Bienheureuse Vierge Marie, Principal Patron du Canada',
    joseph_the_worker: 'Saint Joseph, Artisan (1er s.)',
    ...
    martha_of_bethany: 'Sainte Marthe, Disciple du Christ (1er s.)',
    ...
    martin_of_tours_bishop: 'Saint Martin de Tours, Evêque (✝ 397)',
    mary_magdalene: 'Sainte Marie-Madeleine, Disciple du Christ (1er s.)',
    ...
    remigius_of_reims_bishop: 'Saint Remi, Evêque de Reims (✝ 530)',
    rita_of_cascia_religious: 'Sainte Rita da Cascia, Veuve puis Religieuse (✝ 1456)',
    robert_bellarmine_bishop: 'Saint Robert Bellarmin, Jésuite, Évêque et Docteur de l’Eglise (✝ 1621)',
    ...
    scholastica_of_nursia_virgin: 'Sainte Scolastique, Moniale, Sœur de Saint Benoît (✝ 543)',
    cornelius_i_pope_and_cyprian_of_carthage_bishop_martyrs: 'Saints Martyrs Corneille, Pape, et Cyprien, Évêque (3ème s.)',
    cosmas_of_cilicia_and_damian_of_cilicia_martyrs: 'Saints Côme et Damien, Martyrs (3ème s.)',
    cyril_the_philosopher_monk_and_methodius_of_thessaloniki_bishop: 'Saints Cyrille, Moine, et Méthode, Évêque, Apôtres des Slaves au 9ème siècle',
    ...
    joachim_and_anne_parents_of_mary: 'Saints Anne et Joachim, Mère et Père de la Vierge Marie (1er siècle)',
    john_de_brebeuf_isaac_jogues_priests_and_companions_martyrs: 'Saints Jean de Brébeuf, Isaac Jogues, Prêtres Jésuites, et leurs compagnons, Martyrs (17ème siècle)',
    john_de_brebeuf_isaac_jogues_priests_and_companions_martyrs_secondary_patrons_of_canada: 'Saints Jean de Brébeuf, Isaac Jogues, Prêtres Jésuites, et leurs compagnons, Martyrs, Seconds Patrons du Canada (17ème siècle)',
    ...
    stanislaus_of_szczepanow_bishop: 'Saint Stanislas, Evêque de Cracovie, Martyr (✝ 1079)',
    stephen_i_of_hungary: 'Saint Etienne, Roi de Hongrie (✝ 1038)',
    stephen_the_first_martyr: 'Saint Étienne, Diacre et Premier Martyr (✝ 35)',
    timothy_of_ephesus_and_titus_of_crete_bishops: 'Saints Timothée et Tite, Évêques, Disciples et compagnons de Saint Paul (1er s.)',
    ...
    therese_of_the_child_jesus_and_the_holy_face_of_lisieux_virgin_secondary_patroness_of_france: 'Sainte Thérèse de l’Enfant-Jésus, Vierge, Docteur de l’Église, Seconde Patronne de la France (✝ 1897)',
    ...
    our_lady_of_sorrows_principal_patroness_of_slovakia: 'Notre-Dame des Douleurs, Patronne Principale de la Slovaquie',
    george_of_lydda_martyr_principal_patron_of_england: 'Saint Georges, Martyr et Patron Principal de l’Angleterre (✝ 303)',
    benedict_of_nursia_abbot_principal_patron_of_europe: 'Saint Benoît de Nursie, Patriarche des moines d’Occident, Fondateur de l’ordre des Bénédictins et Patron Principal de l’Europe (✝ v. 547)',
    cyril_the_philosopher_monk_and_methodius_of_thessaloniki_bishop_secondary_patrons_of_europe: 'Saints Cyrille, Moine, et Méthode, Évêque, Apôtres des Slaves au 9ème siècle, Copatrons de l’Europe',
    teresa_benedicta_of_the_cross_stein_virgin_secondary_patron_of_europe: 'Sainte Thérèse-Bénédicte de la Croix (Edith Stein), Carmélite, Martyr en Pologne, Copatronne de l’Europe (✝ 1942)',
    andrew_apostle_principal_patron_of_scotland: 'Saint André, Apôtre et Patron Principal de l’Ecosse',
    bridget_of_sweden_religious_secondary_patroness_of_europe: 'Sainte Brigitte de Suède, Veuve puis Religieuse, Fondatrice de l’ordre du Saint-Sauveur, Copatronne de l’Europe (✝ 1373)',
    catherine_of_siena_virgin_secundary_patroness_of_europe: 'Sainte Catherine de Sienne, Vierge, Docteur de l’Eglise, Copatronne de l’Europe (✝ 1380)',
    catherine_of_siena_virgin_secondary_patroness_of_italy_and_europe: 'Sainte Catherine de Sienne, Vierge, Docteur de l’Eglise, Copatronne de l’Italie et de l’Europe (✝ 1380)',
    patrick_of_ireland_bishop_principal_patron_of_ireland: 'Saint Patrick, Évêque, Patron Principal de l’Irlande (✝ 461)',
    columba_of_iona_abbot_secondary_patron_of_ireland: 'Saint Colomba, Religieux, Patron Secondaire de l’Irlande (✝ 615)',
    our_lady_of_guadalupe_principal_patroness_of_the_americas: 'Notre-Dame de Guadalupe, Patronne Principale des Amériques',
    francis_of_assisi_principal_patron_of_italy: 'Saint François d’Assise, Fondateur de l’ordre des Frères mineurs, Patron de l’Italie (✝ 1226)',
  },
} as RomcalLocale;
