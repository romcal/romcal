...
export default {
  ...
  sanctoral: {
    ...
    saint_adalbert_bishop: 'Svätého Vojtecha, biskupa a mučeníka',
    saint_aelred_of_rievaulx_abbot: 'Svätého Aelreda z Rievaulx, opáta',
    saint_aengus_bishop: 'Svätého Aengusa, biskupa a opáta',
    saint_agatha_of_sicily_virgin: 'Svätej Agáty, panny a mučenice',
    saint_agnes_of_bohemia_virgin: 'Svätej Anežky Českej, panny',
    saint_agnes_tsao_kou_ying_martyr: 'Svätej Agnesy Tsao Kou Yingovej, mučenice',
    saint_agnes_of_rome_virgin: 'Svätej Agnesy, panny a mučenice',
    saint_aidan_of_ferns_bishop: 'Svätého Aidana, biskupa',
    saint_aidan_of_lindisfarne_bishop_and_the_saints_of_lindisfarne: 'Svätého Aidana, biskupa a lindisfarnských svätých',
    saint_aidan_of_lindisfarne_bishop: 'Svätého Aidana Lindisfarnského, biskupa a misionára',
