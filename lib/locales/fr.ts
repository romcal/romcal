export default {
  ...
  epiphany: {
    season: 'Épiphanie',
    before: '{{day}} avant l’Épiphanie',
    after: '{{day}} après l’Épiphanie',
  },
  ordinary_time: {
  ...
  celebrations: {
    ...
    palm_sunday: 'Dimanche des Rameaux et de la Passion du Seigneur',
  ...
  sanctorale: {
    adalbert_of_prague_bishop:
      'Saint Adalbert, Évêque de Prague et Martyr (✝ 997)',
    ...
    andrew_apostle_patron_of_scotland:
      'Saint André, Apôtre et Patron de l’Écosse',
    ...
    apollinaris_of_ravenna_bishop:
      'Saint Apollinaire, Évêque et Martyr (IIème s.)',
    ...
    bede_the_venerable_priest:
      'Saint Bède le Vénérable, Prêtre et docteur de l’Église (✝ 735)',
    ...
    catherine_of_alexandria_virgin:
      'Sainte Catherine d’Alexandrie, Vierge et Martyre (IVème s.)',
    ...
    cosmas_of_cilicia_and_damian_of_cilicia_martyrs:
      'Saints Côme et Damien, Martyrs (IIIème s.)',
    ...
    genevieve_of_paris_virgin: 'Sainte Geneviève, Vierge à Paris (✝ 500)',
    ...
    josephine_bakhita_virgin:
      'Sainte Joséphine Bakhita, Vierge et Religieuse (✝ 1947)',
    ...
    louis_grignion_de_montfort_priest:
      'Saint Louis-Marie Grignion de Montfort, Prêtre (✝ 1716)',
    ...
    scholastica_of_nursia_virgin:
      'Sainte Scholastique, Moniale, Sœur de Saint Benoît (✝ 543)',
    ...
    sixtus_ii_pope_and_companions_martyrs:
      'Saint Sixte II, Pape, et ses Diacres, Martyrs (✝ 258)',
