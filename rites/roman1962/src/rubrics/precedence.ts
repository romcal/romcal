import type { LiturgicalDay1962Init } from '../models/liturgical-day';
...
function fineAdjustment(c: LiturgicalDay1962Init): number {
  if (c.kind === 'tempora') {
...
export function scorePrecedence(c: LiturgicalDay1962Init): number {
