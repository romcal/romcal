...
export default {
  ...
  sanctoral: {
    ...
    joan_of_arc_virgin_secondary_patroness_of_france: 'Svätej Jany z Arku, panny a sekundárnej patrónky Francúzska',
    ...
    rose_of_lima_virgin_secondary_patroness_of_the_philippines: 'Svätej Ruženy Limskej, panny a sekundárnej patrónky Filipín',
    ...
    john_de_brebeuf_isaac_jogues_priests_and_companions_martyrs_secondary_patrons_of_canada: 'Svätých Jána de Brébeuf a Izáka Joguesa, kňazov a spoločníkov, mučeníkov, sekundárnych patrónov Kanady',
    ...
    therese_of_the_child_jesus_and_the_holy_face_of_lisieux_virgin_secondary_patroness_of_france: 'Svätej Terézie od Dieťaťa Ježiša a Svätej tváre z Lisieux, panny, učiteľky Cirkvi a sekundárnej patrónky Francúzska',
