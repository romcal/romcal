...
export default {
  ...
  sanctoral: {
    ...
    joseph_spouse_of_mary_principal_patron_of_canada: 'San José, Esposo de la Santísima Vírgen María, Principal Patrono de Canadá',
    ...
    saintMartinDePorresReligious: 'San Martín de Porres, Religioso',
    ...
    saintMiguelFebresCorderoReligious: 'San Miguel Febres Cordero, Religioso',
