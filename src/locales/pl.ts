...
export default {
  ...
  sanctoral: {
    ...
    catherine_of_siena_virgin_copatroness_of_europe:
      'Św. Katarzyny Sieneńskiej, dziewicy, doktora Kościoła i patronki Europy', // TODO: How to say `secundary patroness` in Polish?
    catherine_of_siena_virgin_copatroness_of_italy_and_europe:
      'Św. Katarzyny Sieneńskiej, dziewicy, doktora Kościoła i patronki Włoch i Europy', // TODO: How to say `secundary patroness` in Polish?
    ...
    cyril_the_philosopher_monk_and_methodius_of_thessaloniki_bishop_copatrons_of_europe:
      'Świętych Cyryla, mnicha i Metodego, biskupa, patronów Europy', // TODO: How to say `secundary patrons` in Polish?
    ...
    teresa_benedicta_of_the_cross_stein_virgin_copatroness_of_europe:
      'Św. Teresy Benedykty od Krzyża, dziewicy, męczennicy i patrona Europy', // TODO: How to say `secundary patroness` in Polish?
    ...
    wenceslaus_i_of_bohemia_martyr_patron_of_the_czech_nation: 'Św. Wacława, męczennika i patrona narodu czeskiego',
