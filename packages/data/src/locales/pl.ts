...
export const locale: Locale = {
  ...
  names: {
    ...
    adelaide_of_burgundy_empress: 'Św. Adelajdy Burgundzkiej, cesarzowy',
    ...
    arbogast_of_strasbourg_bishop_patron_of_the_archdiocese_of_strasbourg:
      'Św. Arbogasta, biskupa i patrona archidiecezji Strasburga',
    ...
    aurelia_of_strasbourg_virgin: 'Św. Aurelie ze Strasburga, dziewicy',
    ...
    benedict_of_aniane_abbot: 'Św. Benedykt z Anianu, opata',
    ...
    blessed_martyrs_of_paris: 'Bł. Męczennicy z Paryża',
    ...
    brigid_of_kildare_virgin: 'Św. Brygidy z Kildare, opatky',
    ...
    daniel_brottier_priest: 'Bł. Daniela Brottier, prezbitera',
    ...
    dedication_of_the_cathedral_basilica_of_saint_denis_france:
      'Rocznica poświęcenia Bazyliky Katedralnej Saint-Denis, Francja',
    ...
    louise_de_marillac_religious: 'Św. Ludwiky de Marillac, religiosæ',
    ...
    marie_eugenie_of_jesus_milleret_de_brou_virgin:
      'Św. Marii Eugenii od Jezusa Milleret de Brou, dziewicy i założycielky',
    ...
    mederic_of_autun_and_droctoveus_of_autun_abbots: 'Św. Mederyka i Droctovæi, opatów',
    ...
    richardis_of_swabia_empress: 'Św. Ryszardy, cesarzowy',
    ...
    rosalie_jeanne_marie_rendu_virgin: 'Bł. Rozalii Rendu, panny',
    ...
    sunday_of_the_word_of_god: '{{week}}. Niedziela zwykła, lub Niedziela Słowa Bożego',
    ...
    odile_of_alsace_abbess: 'Św. Otylii, opatky',
    odile_of_alsace_abbess_patroness_of_alsace: 'Św. Otylii, opatky, patronka Alzacji',
