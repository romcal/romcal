...
## [v2.0.0-alpha.0](https://github.com/romcal/romcal/compare/v1.3.1-alpha.8...v2.0.0-alpha.0) - 2021-05-19

### Commits

- docs: [ci skip] Update changelog [`259a21a`](https://github.com/romcal/romcal/commit/259a21a4d328be777340297c65d0a3415adb3eed)
- task: fix the date of saint pedro calungsod, martyr [`a83d32e`](https://github.com/romcal/romcal/commit/a83d32e7edbe80e9402e0d0758f7abe6c4fe678e)
- docs: [ci skip] Update changelog [`223fc10`](https://github.com/romcal/romcal/commit/223fc1042065bdce32d3adf68e0f244c71e78b6a)

## [v1.3.1-alpha.8](https://github.com/romcal/romcal/compare/v1.3.1-alpha.7...v1.3.1-alpha.8) - 2021-05-19

### Merged

- task: remove explicit HDO definitions from celebrations that always occur on Sunday [`#285`](https://github.com/romcal/romcal/pull/285)

### Commits

- task: on calendar def, rename the source prop to namespace [`8234c91`](https://github.com/romcal/romcal/commit/8234c91bb677c9797cef4ae8b06315fc4c4aea63)
- docs: [ci skip] Update changelog [`47de5f9`](https://github.com/romcal/romcal/commit/47de5f9a8522471225240b4381f2e2867bdac0fb)
- docs: remove doc duplicate about RomcalLiturgicalDayNamespace [`b60ecee`](https://github.com/romcal/romcal/commit/b60eceede161dcdd348a6d11d615ac62b2dbaa1f)

## [v1.3.1-alpha.7](https://github.com/romcal/romcal/compare/v1.3.1-alpha.6...v1.3.1-alpha.7) - 2021-05-19

### Merged

- fix: HDO definitions for `general` and `slovakia` [`#281`](https://github.com/romcal/romcal/pull/281)

### Commits

- fix: sanctorale spelling [`6e3e158`](https://github.com/romcal/romcal/commit/6e3e158d6c259d6f85faaf98459e276154c52d3e)
- docs: [ci skip] Update changelog [`d281c7b`](https://github.com/romcal/romcal/commit/d281c7bde1fd6e303fb295e6d1ce41875a14ea21)
- fix: you now can ommit the date if you drop a calendar def [`8fadb22`](https://github.com/romcal/romcal/commit/8fadb224b5875bcc83b5362cd335603dbdefbb16)

## [v1.3.1-alpha.6](https://github.com/romcal/romcal/compare/v1.2.0...v1.3.1-alpha.6) - 2021-05-18

### Merged

- task: improve Polish locale [`#251`](https://github.com/romcal/romcal/pull/251)
