...
const dates = async (config: RomcalConfig): Promise<Array<RomcalLiturgicalDayInput>> => {
  ...
  const _dates: Array<RomcalLiturgicalDayInput> = [
    {
      // TODO: When votive Masses (#110) are implemented, change this celebration into votive Mass of `cyril_the_philosopher_monk_and_methodius_of_thessaloniki_bishop_secondary_patrons_of_europe`
    ...
    {
      key: 'our_lady_of_sorrows_principal_patroness_of_slovakia',
      rank: Ranks.SOLEMNITY,
