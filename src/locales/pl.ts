...
export default {
  ...
  sanctoral: {
    ...
    saint_adalbert_bishop: 'Św. Wojciecha, biskupa i męczennika, głównego patrona Polski',
    saint_agatha_of_sicily_virgin: 'Św. Agaty, dziewicy i męczennicy',
    saint_agnes_tsao_kou_ying_martyr: 'Św. Agnieszki Tsao Kou Ying, Męczennicy',
    saint_agnes_of_rome_virgin: 'Św. Agnieszki, dziewicy i męczennicy',
