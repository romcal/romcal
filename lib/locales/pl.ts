export default {
  ...
  sanctorale: {
    ...
    alberic_crescitelli_priest:
      'Św. Alberyka Crescitellego, prezbitera i męczennika',
    ...
    andrew_apostle_patron_of_scotland:
      'Św. Andrzeja, Apostoła, patrona Szkocji',
    ...
    augustine_zhao_rong_priest:
      'Św. Augustyna Zhao Rong, prezbitera i męczennika',
    ...
    columba_of_iona_abbot_copatron_of_ireland:
      'Św. Kolumbana, zakonnika, patrona Irlandii',
    ...
    george_of_lydda_martyr_patron_of_england:
      'Św. Grzegorza, męczennika, patrona Anglii',
    ...
    john_gabriel_perboyre_priest:
      'Św. Jana Gabriela Perboyre’a, prezbitera i męczennika',
    ...
    our_lady_queen_of_poland:
      'Najświętszej Maryi Panny, Królowej Polski, głownej patronki Polski',
    ...
    patrick_of_ireland_bishop_patron_of_ireland:
      'Św. Patryka, biskupa, patrona Irlandii',
