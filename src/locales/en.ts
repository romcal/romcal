...
export default {
  ...
  sanctoral: {
    ...
    catherine_of_saint_augustine_virgin: 'Blessed Catherine of Saint Augustine, Virgin',
    ...
    immaculate_conception_of_mary_principal_patroness_of_the_philippines: 'Immaculate Conception of the Blessed Virgin Mary, Principal Patroness of the Philippines',
    ...
    our_lady_of_guadalupe_principal_patroness_of_the_philippines: 'Our Lady of Guadalupe, Principal Patroness of the Philippines',
    ...
    andrew_apostle_principal_patron_of_russia: 'Saint Andrew, Apostle and Principal Patron of Russia',
    angela_merici_virgin: 'Saint Angela Merici, Virgin',
    joachim_and_anne_principal_patroness_of_the_province_of_quebec_parents_of_mary: 'Saints Anne, Principal Patroness of the Province of Quebec, and Joachim, Parents of the Blessed Virgin Mary',
    ...
    brigid_of_kildare_virgin_secondary_patron_of_ireland: 'Saint Brigid, Virgin and Secondary Patron of Ireland',
    ...
    columban_of_ireland_abbot: 'Saint Columban, Abbot',
    ...
    francois_de_laval_bishop: 'Saint François de Laval, Bishop',
    ...
    hedwig_religious: 'Saint Hedwig, Religious',
    ...
    james_apostle_principal_patron_of_spain: 'Saint James, Apostle and Principal Patron of Spain',
    ...
    john_neumann_bishop: 'Saint John Neumann, Bishop',
    ...
    john_of_god_religious: 'Saint John of God, Religious',
    ...
    joseph_spouse_of_mary_principal_patron_of_canada: 'Saint Joseph, Spouse of the Blessed Virgin Mary and Principal Patron of Canada',
    ...
    john_de_brebeuf_isaac_jogues_priests_and_companions_martyrs_secondary_patrons_of_canada: 'Saints John de Brébeuf and Isaac Jogues, Priests, and Companions, Martyrs and Secondary Patrons of Canada',
    ...
    therese_of_the_child_jesus_and_the_holy_face_of_lisieux_virgin_secondary_patroness_of_france: 'Saint Thérèse of the Child Jesus and the Holy Face of Lisieux, Virgin, Doctor of the Church and Secondary Patroness of France',
    ...
    immaculate_conception_of_mary_principal_patroness_of_the_usa: 'Immaculate Conception of the Blessed Virgin Mary, Principal Patroness of the USA',
    peter_chanel_priest_principal_patron_of_oceania: 'Saint Peter Chanel, Proto-martyr of Oceania and Principal Patron of Oceania',
    ...
    our_lady_of_sorrows_principal_patroness_of_slovakia: 'Our Lady of Sorrows, Principal Patroness of Slovakia',
    george_of_lydda_martyr_principal_patron_of_england: 'Saint George, Martyr and Principal Patron of England',
    benedict_of_nursia_abbot_principal_patron_of_europe: 'Saint Benedict, Abbot and Principal Patron of Europe',
    cyril_the_philosopher_monk_and_methodius_of_thessaloniki_bishop_secondary_patrons_of_europe: 'Saints Cyril, Monk, and Methodius, Bishop',
    ...
    teresa_benedicta_of_the_cross_stein_virgin_secondary_patron_of_europe: 'Saint Teresa Benedicta of the Cross Stein, Virgin, Martyr and Secondary Patron of Europe',
    andrew_apostle_principal_patron_of_scotland: 'Saint Andrew, Apostle and Principal Patron of Scotland',
    david_of_wales_bishop_principal_patron_of_wales: 'Saint David, Bishop and Principal Patron of Wales',
    bridget_of_sweden_religious_secondary_patroness_of_europe: 'Saint Bridget, Religious and Secondary Patroness of Europe',
    catherine_of_siena_virgin_secundary_patroness_of_europe: 'Saint Catherine of Siena, Virgin, Doctor of the Church and Secundary Patroness of Europe',
    catherine_of_siena_virgin_secondary_patroness_of_italy_and_europe: 'Saint Catherine of Siena, Virgin, Doctor of the Church and Secundary Patroness of Italy and Europe',
    patrick_of_ireland_bishop_principal_patron_of_ireland: 'Saint Patrick, Bishop and Principal Patron of Ireland',
    columba_of_iona_abbot_secondary_patron_of_ireland: 'Saint Columba, Abbot, Missionary and Secondary Patron of Ireland',
    our_lady_of_guadalupe_principal_patroness_of_the_americas: 'Our Lady of Guadalupe, Principal Patroness of the Americas',
    francis_of_assisi_principal_patron_of_italy: 'Saint Francis of Assisi, Principal Patron of Italy',
  },
} as RomcalLocale;
