import { CalendarDefInput, DayOfWeek, Precedence, ProperCycle } from '@romcal/shared';

export const China: CalendarDefInput = {
  calendarId: 'china',
  ...
  inputs: {
    ...
    our_lady_of_china: {
      ...
      dateDef: { month: 5, dayOfWeek: DayOfWeek.Saturday, nthWeekInMonth: 2 },
    },
