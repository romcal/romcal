...
export default {
    ...
    sanctoral: {
        ...
        saintWenceslausMartyrSaintLawrenceRuizAndCompanionsMartyrs: "Saint Venceslas, Martyr (✝ 929), ou Saints Laurent Ruiz et 15 compagnons, Martyrs à Nagasaki au Japon (✝ v. 1635)",
