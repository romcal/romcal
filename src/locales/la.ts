...
export default {
  ...
  sanctoral: {
    ...
    our_lady_mother_of_divine_providence_principal_patroness_of_puerto_rico: 'B. Mariæ Virginis Divinæ Providentiæ Matris atque Patronæ principalis Portus Divitis',
