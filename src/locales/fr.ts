...
export default {
  ...
  sanctoral: {
    ...
    cyril_the_philosopher_monk_and_methodius_of_thessaloniki_bishop:
      'Saints Cyrille, Moine, et Méthode, Évêque, Apôtres des Slaves au 9ème siècle',
    cyril_the_philosopher_monk_and_methodius_of_thessaloniki_bishop_copatrons_of_europe:
      'Saints Cyrille, Moine, et Méthode, Évêque, Apôtres des Slaves au 9ème siècle, Co-Patrons de l’Europe',
    ...
    joachim_and_anne_patroness_of_the_province_of_quebec_parents_of_mary:
      'Saints Anne, Patronne de la province civile de Québec, et Joachim, Parents de la Vierge Marie (1er siècle)',
    ...
    john_de_brebeuf_isaac_jogues_priests_and_companions_martyrs_copatrons_of_canada:
      'Saints Jean de Brébeuf, Isaac Jogues, Prêtres Jésuites, et leurs compagnons, Martyrs, Co-Patrons du Canada (17ème siècle)',
    ...
    stanislaus_of_szczepanow_bishop_patron_of_poland:
      'Saint Stanislas, Evêque de Cracovie, Martyr et Patron de la Pologne (✝ 1079)',
