import { CalendarDefInput, Color, DayOfWeek, Precedence, ProperCycle } from '@romcal/shared';
...
export const GeneralRoman: CalendarDefInput = {
  calendarId: 'general-roman',
  ...
  inputs: {
    basil_the_great_and_gregory_nazianzen_bishops: {
      precedence: Precedence.GeneralMemorial_10,
    ...
    conversion_of_saint_paul_the_apostle: {
      precedence: Precedence.GeneralFeast_7,
    ...
    joseph_spouse_of_mary: {
      ...
      dateExceptions: [
        { ifIsDayOfWeek: DayOfWeek.Sunday, setDate: { addDay: 1 } },
        {
          ifIsBetween: {
    ...
    dedication_of_consecrated_churches_on_october_25: {
      precedence: Precedence.ProperSolemnity_DedicationOfTheOwnChurch_4b,
    ...
    dedication_of_consecrated_churches_on_last_sunday_of_october: {
      precedence: Precedence.ProperSolemnity_DedicationOfTheOwnChurch_4b,
      customLocaleKey: 'dedication_of_consecrated_churches',
      dateDef: { month: 10, lastDayOfWeekInMonth: DayOfWeek.Sunday },
      isOptional: true,
    },
