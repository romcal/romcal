...
export default {
  ...
  sanctoral: {
    ...
    saint_adalbert_bishop: 'S. Adalberti, episcopi et martyris',
    saint_aelred_of_rievaulx_abbot: 'S. Ælredi Riævallensis, abbatis',
    saint_aengus_bishop: 'S. Ængi, episcopi et abbatis',
    saint_agatha_of_sicily_virgin: 'S. Agathæ, virginis et martyris',
    saint_agnes_of_bohemia_virgin: 'S. Agnetis de Bohemia, virginis',
    saint_agnes_tsao_kou_ying_martyr: 'S. Agnetis Tsao Kou Ying, martyris',
    saint_agnes_of_rome_virgin: 'S. Agnetis, virginis et martyris',
    saint_aidan_of_ferns_bishop: 'S. Ædani Lindisfarnensis, episcopi',
    saint_aidan_of_lindisfarne_bishop_and_the_saints_of_lindisfarne: 'Ss. Ædani, episcopi et Sanctorum Lindisfarnensis',
    saint_aidan_of_lindisfarne_bishop: 'S. Ædani Lindisfarnensis, episcopi',
