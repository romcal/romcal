...
export const locale: Locale = {
  ...
  names: {
    ...
    adeltrude_of_aurillac: 'Sainte Adeltrude d’Aurillac',
    ...
    agnes_of_jesus_galand_virgin: 'Bienheureuse Agnès de Jésus Galand, vierge († 1634)',
    ...
    all_saints_of_the_diocese_of_nimes: 'Tous les Saints de l’Église de Nîmes', // src: mr_fr_1984_ed1_nimes
    ...
    alypius_of_thagaste_and_possidius_of_calama_bishops: 'Saints Alype et Possidius, évêques',
    alypius_of_thagaste_bishop: 'Saint Alype, évêque († v. 430)',
    ...
    anthony_of_lialores_hermit: 'Saint Antoine de Lialores, ermite et martyr († 540)',
    ...
    antoine_charles_du_bouzet_bertrand_antoine_de_caupenne_priests_and_companions_martyrs:
      'Bienheureux Antoine-Charles du Bouzet et Bertrand-Antoine de Caupenne, prêtres, et leurs compagnons, martyrs († 1792)',
    antoine_charles_du_bouzet_priest: 'Bienheureux Antoine-Charles du Bouzet, prêtre et martyr († 1792)',
    antonin_of_pamiers_martyr: 'Saint Antonin, martyr',
    antonin_of_pamiers_martyr_principal_patron_of_the_diocese_of_pamiers:
      'Saint Antonin, martyr, titulaire de la cathédrale et patron principal du diocèse',
    ...
    assumption_of_the_blessed_virgin_mary_principal_patroness_of_the_diocese_of_nimes:
      'Assomption de la Sainte Vierge, patronne du diocèse', // src: mr_fr_1984_ed1_nimes
    ...
    austremonius_of_clermont_bishop: 'Saint Austremoine, premier évêque d’Auvergne',
    ...
    benezet_of_avignon: 'Saint Bénézet', // src: mr_fr_1984_ed1_nimes
    benildus_romancon_religious: 'Saint Bénilde Romançon, religieux († 1862)',
    berard_of_carbio_and_companions_martyrs: 'Saint Bérard et ses compagnons, martyrs',
    ...
    bertrand_antoine_de_caupenne_priest: 'Bienheureux Bertrand-Antoine de Caupenne, prêtre et martyr († 1792)',
    ...
    bertrand_of_garrigues_priest: 'Bienheureux Bertrand de Garrigues, prêtre', // src: mr_fr_1984_ed1_nimes
    ...
    calais_of_anisole_abbot: 'Saint Calais, abbé d’Anisole († v. 542)', // src: mr_fr_1998_ed1_laval
    calais_of_anisole_and_siviard_of_anisole_abbots: 'Saints Calais et Siviard, abbés', // src: mr_fr_1998_ed1_laval
    ...
    cecilia_of_rome_virgin_principal_patroness_of_the_archdiocese_of_albi:
    ...
    cornelius_i_pope: 'Saint Corneille, pape et martyr († 253)',
    ...
    crispina_of_thagora_martyr: 'Sainte Crispine, martyre († 304)',
    cyprian_of_carthage_bishop: 'Saint Cyprien, évêque et martyr († 258)',
    cyprian_of_carthage_bishop_patron_of_north_africa:
      'Saint Cyprien, évêque et martyr, patron de l’Afrique du Nord († 258)',
    ...
    dedication_of_the_cathedral_of_algiers_algeria: 'Dédicace de la cathédrale d’Alger',
    ...
    dedication_of_the_cathedral_of_tripoli_libya: 'Dédicace de la cathédrale de Tripoli',
    dedication_of_the_cathedral_of_tunis_tunisia: 'Dédicace de la cathédrale de Tunis',
    ...
    deogratias_of_carthage_bishop: 'Saint Deogratias, évêque de Carthage († 457)',
    ...
    francis_of_assisi_patron_of_the_apostolic_vicariate_of_tripoli:
      'Saint François d’Assise, patron du vicariat apostolique de Tripoli († 1226)',
    ...
    francois_louis_meallet_de_fargues_priest_and_companions_martyrs:
      'Bienheureux François-Louis Méallet de Fargues, prêtre, et ses compagnons, martyrs († 1792)',
    ...
    fulgentius_of_ruspe_bishop: 'Saint Fulgence, évêque († 527)',
    ...
    gelasius_i_pope: 'Saint Gélase Ier, pape († 496)',
    ...
    gerald_of_aurillac: 'Saint Géraud d’Aurillac († 909)',
    gerald_of_braga_bishop: 'Saint Géraud de Braga, évêque († 1108)',
    gerard_of_lunel_hermit: 'Bienheureux Gérard de Lunel, ermite', // src: mr_fr_1984_ed1_nimes
    ...
    immaculate_conception_of_the_blessed_virgin_mary_patroness_of_the_archdiocese_of_tangier:
      'Immaculée Conception de la Bienheureuse Vierge Marie, patronne de l’archidiocèse de Tanger',
    ...
    jacques_ledoyen_priest_and_companions_martyrs: 'Bienheureux Jacques Ledoyen, prêtre, et ses compagnons, martyrs', // src: mr_fr_1998_ed1_laval
    jacques_ledoyen_priest_martyr: 'Bienheureux Jacques Ledoyen, prêtre et martyr († 1794)', // src: mr_fr_1998_ed1_laval
    james_apostle: 'Saint Jacques le Majeur, apôtre († 44)',
    james_of_lambaesis_deacon: 'Saint Jacques, diacre et martyr († 259)',
    james_of_lambaesis_deacon_marian_of_lambaesis_lector_and_companions_martyrs:
      'Saints Jacques, diacre, Marien, lecteur, et leurs compagnons, martyrs',
    ...
    jean_turpin_du_cormier_priest_and_companions_martyrs:
      'Bienheureux Jean Turpin du Cormier, prêtre, et ses compagnons, martyrs', // src: mr_fr_1998_ed1_laval
    jeanne_delanoue_of_the_cross_religious: 'Sainte Jeanne Delanoue, religieuse († 1736)', // mr_fr_2022_ed3_angers
    jeanne_emilie_de_villeneuve_virgin: 'Sainte Jeanne-Émilie de Villeneuve, vierge († 1854)', // src: https://albi.catholique.fr/wp-content/uploads/sites/24/2026/04/calendrier-liturgique-propre-du-diocese-dalbi.pdf
    jeanne_jugan_virgin: 'Sainte Jeanne Jugan, vierge († 1879)', // src: https://diocesedelaval.fr/le-propre-du-diocese-de-laval/
    ...
    joseph_louis_marcou_and_joseph_henri_chamayou_religious_martyrs:
      'Bienheureux Joseph Louis Marcou (Frère Louis de Jésus) et Henri Chamayou (Frère Jacob Samuel), religieux et martyrs († 1936)', // src: https://albi.catholique.fr/wp-content/uploads/sites/24/2026/04/calendrier-liturgique-propre-du-diocese-dalbi.pdf
    joseph_louis_marcou_religious: 'Bienheureux Joseph-Louis Marcou, religieux et martyr († 1936)', // src: https://albi.catholique.fr/wp-content/uploads/sites/24/2026/04/calendrier-liturgique-propre-du-diocese-dalbi.pdf
    ...
    leontius_of_frejus_bishop: 'Saint Léonce, évêque', // src: mr_fr_1984_ed1_nimes
    ...
    luperc_of_eauze_martyr: 'Saint Luperc, martyr († v. 250)',
    ...
    marcellinus_of_carthage_martyr: 'Saint Marcellin, martyr à Carthage († 413)',
    ...
    marcellus_of_tangier_and_maximilian_of_tebessa_martyrs: 'Saints Marcel et Maximilien, martyrs',
    marcellus_of_tangier_martyr: 'Saint Marcel, martyr à Tanger († 298)',
    marciana_of_mauretania_virgin: 'Sainte Marcienne, vierge et martyre († IVe s.)',
    ...
    margaret_of_lorraine_religious: 'Bienheureuse Marguerite d’Alençon, veuve et religieuse († 1521)', // src: mr_fr_1998_ed1_laval
    ...
    marian_of_lambaesis_lector: 'Saint Marien, lecteur et martyr († 259)',
    ...
    martiana_of_albi_virgin: 'Sainte Martiane, vierge', // src: https://albi.catholique.fr/wp-content/uploads/sites/24/2026/04/calendrier-liturgique-propre-du-diocese-dalbi.pdf
    ...
    mary_of_clopas_and_salome_disciples: 'Saintes Marie Jacobé et Marie Salomé, disciples du Seigneur', // src: mr_fr_1984_ed1_nimes
    mary_of_clopas_disciple: 'Sainte Marie Jacobé, disciple du Seigneur', // src: mr_fr_1984_ed1_nimes
    ...
    mary_rivier_virgin: 'Sainte Marie Rivier, vierge', // src: https://www.nimes-catholique.fr/saints-du-diocese-de-nimes/
    ...
    maurice_of_agaunum_and_companions_martyrs: 'Saint Maurice et ses compagnons, martyrs († v. 287)', // src: mr_fr_2014_ed2_lyon
    ...
    monica_of_hippo_mother_of_a_family: 'Sainte Monique, mère de famille († 387)',
    ...
    odilo_of_cluny_abbot: 'Saint Odilon, abbé de Cluny († 1049)',
    odo_of_cluny_abbot: 'Saint Odon, abbé de Cluny († 942)',
    optatus_of_milevis_bishop: 'Saint Optat, évêque († IVe s.)',
    ...
    our_lady_of_africa: 'Bienheureuse Vierge Marie, Notre-Dame d’Afrique',
    our_lady_of_boulogne: 'Notre-Dame de Boulogne', // src: mr_fr_2009_ed2_paris_creteil_nanterre_saint_denis
    our_lady_of_carthage: 'Bienheureuse Vierge Marie de Carthage',
    ...
    our_lady_of_miracles_of_mauriac: 'Notre-Dame des Miracles de Mauriac',
    ...
    perpetua_of_carthage_and_felicity_of_carthage_and_companions_martyrs:
      'Saintes Perpétue et Félicité, et leurs compagnons, martyrs',
    ...
    pierre_claverie_bishop: 'Bienheureux Pierre Claverie, évêque et martyr († 1996)',
    pierre_claverie_bishop_and_companions_religious_martyrs:
      'Bienheureux Pierre Claverie, évêque, et ses compagnons, religieux et martyrs',
    ...
    pons_of_villeneuve_les_avignon_abbot: 'Saint Pons, abbé', // src: mr_fr_1984_ed1_nimes
    ...
    possidius_of_calama_bishop: 'Saint Possidius, évêque de Calama',
    ...
    quodvultdeus_of_carthage_bishop: 'Saint Quodvultdeus, évêque de Carthage († avant 454)',
    ...
    raymond_cayre_priest_and_companions_martyrs:
      'Bienheureux Raymond Cayré, prêtre, et ses compagnons, martyrs († 1944-1945)', // src: https://albi.catholique.fr/wp-content/uploads/sites/24/2026/04/calendrier-liturgique-propre-du-diocese-dalbi.pdf
    ...
    siviard_of_anisole_abbot: 'Saint Siviard, abbé d’Anisole († 687)', // src: mr_fr_1998_ed1_laval
    sixtus_ii_pope_and_companions_martyrs: 'Saint Sixte II, pape, et ses diacres, martyrs († 258)',
    speratus_of_scillium_and_companions_martyrs: 'Saint Spérat et ses compagnons, martyrs',
    speratus_of_scillium_martyr: 'Saint Spérat, martyr († 180)',
    ...
    taurin_of_eauze_martyr: 'Saint Taurin, martyr',
    ...
    theodechilde_of_sens_virgin: 'Sainte Théodéchilde, vierge († v. 568)',
    ...
    till_of_solignac_abbot: 'Saint Till, abbé († 700)',
    ...
    udault_of_ax_priest: 'Saint Udault, prêtre et martyr à Ax († 452)', // src: mr_fr_1974_ed1_region_apostolique_du_midi
