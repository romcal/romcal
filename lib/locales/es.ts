...
export const locale: Locale = {
  ...
  names: {
    ...
    andrew_kim_tae_gon_priest_paul_chong_ha_sang_and_companions_martyrs:
      'Santos Andrés Kim Taegon, presbítero, y Pablo Chong Hasang, y compañeros, mártires',
    ...
    anthony_zaccaria_priest: 'San Antonio María Zaccaría, Sacerdote',
    apollinaris_of_ravenna_bishop: 'San Apolinar de Rávena, Obispo y Mártir',
    ...
    assumption_of_the_blessed_virgin_mary: 'La Asunción de la Santísima Vírgen María',
    ...
    augustine_zhao_rong_priest_and_companions_martyrs: 'San Agustín Zhao Rong, Sacerdote, y compañeros, Mártires',
    aurelia_of_strasbourg_virgin: 'Santa Aurelia de Estrasburgo, Vírgen',
    ...
    bartholomew_dias_laurel_religious: 'Beato Bartolomé Días Laurel, Religioso y Mártir',
    ...
    benedict_of_nursia_abbot: 'San Benito de Nursia, Abad',
    ...
    bridget_of_sweden_religious: 'Santa Brígida de Suecia',
    ...
    cajetan_of_thiene_priest: 'San Cayetano de Thiene, Sacerdote',
    callistus_i_pope: 'San Calixto I, Papa y Mártir',
    camillus_de_lellis_priest: 'San Camilo de Lelis (Lellis), Sacerdote',
    ...
    catherine_of_siena_virgin: 'Santa Catalina de Siena, Vírgen y Doctora de la Iglesia',
    catherine_of_siena_virgin_copatroness_of_europe:
      'Santa Catalina de Siena, Vírgen, Doctora de la Iglesia y Patrona Secundaria de Europa',
    catherine_of_siena_virgin_copatroness_of_italy_and_europe:
      'Santa Catalina de Siena, Vírgen, Doctora de la Iglesia y Patrona Secundaria de Italia y Europa',
    catherine_zoe_laboure_virgin: 'Santa Catalina Labouré, Vírgen',
    ...
    charles_of_jesus_de_foucauld: 'Santos Carlos de Foucauld, Sacerdote',
    ...
    commemoration_of_all_the_faithful_departed: 'Todas las almas',
    ...
    cyril_constantine_the_philosopher_monk_and_methodius_michael_of_thessaloniki_bishop:
      'San Cirilo El Filósofo, Monje, y San Metodio de Tesalónica, Obispo',
    ...
    denis_of_paris_bishop_and_companions_martyrs: 'San Dionisio y compañeros, Mártires',
    ...
    fidelis_of_sigmaringen_priest: 'San Fidel de Sigmaringa, Sacerdote',
    ...
    francis_borgia_priest: 'San Francisco de Borja, Sacerdote',
    ...
    francis_solanus_priest: 'San Francisco Solano, Sacerdote',
    ...
    fructuosus_of_tarragona_bishop_and_augurius_of_tarragona_and_eulogius_of_tarragona_deacons_martyrs:
      'San Fructuoso, Obispo de Tarragona, San Augurio, diácono de Tarragona, y San Eulogio, diácono de Tarragona, Mártires',
    ...
    henry_ii_emperor: 'San Enrique II',
    hermenegild_the_visigoths_martyr: 'San Hermenegildo, Mártir visigodo',
    ...
    holy_guardian_angels: 'Ángeles Custodios',
    ...
    irenaeus_of_lyon_bishop: 'San Ireneo de Lyon, Obispo y Doctor de la Iglesia',
    isabelle_of_france_virgin: 'Beata Isabel de Francia, Vírgen',
    ...
    januarius_i_of_benevento_bishop: 'San Genaro de Benevento, Obispo y Mártir',
    ...
    john_damascene_priest: 'San Juan Damasceno, Sacerdote y Doctor de la Iglesia',
    john_de_brebeuf_isaac_jogues_priests_and_companions_martyrs:
      'San Juan de Brébeuf, Isaac Jogues, y compañeros, Mártires',
    john_eudes_priest: 'San Juan Eudes, Sacerdote',
    john_fisher_bishop_and_thomas_more_martyrs: 'Santos Juan Fisher y Tomás Moro, Mártires',
    john_i_pope: 'San Juan I, Papa y Mártir',
    john_leonardi_priest: 'San Juan Leonardi, Sacerdote',
    john_mary_vianney_priest: 'San Juan María Vianney, Sacerdote',
    john_of_avila_priest: 'San Juan de Ávila, Sacerdote y Doctor de la Iglesia',
    john_of_capistrano_priest: 'San Juan de Capistrano, Sacerdote',
    john_of_god_duarte_cidade_religious: 'San Juan de Dios, Religioso',
    john_of_kanty_priest: 'San Juan de Kanty, Sacerdote',
    ...
    josaphat_kuntsevych_bishop: 'San Josafat Kuncewycz, Obispo y Mártir',
    ...
    junipero_serra_priest: 'San Junípero Serra, Sacerdote',
    ...
    lawrence_of_brindisi_priest: 'San Lorenzo de Brindis, Sacerdote y Doctor de la Iglesia',
    ...
    louis_grignion_de_montfort_priest: 'San Luis María Grignion de Montfort, Sacerdote',
    louis_ix_of_france: 'San Luis',
    louise_de_marillac_religious: 'Santa Luisa de Marillac, Religiosa',
    lucy_of_syracuse_virgin: 'Santa Lucía de Siracusa, Virgen y Mártir',
    ludan_of_scotland_pilgrim: 'San Ludano, peregrino',
    luigi_orione_priest: 'San Luis Orione, Sacerdote',
    luke_evangelist: 'San Lucas, evangelista',
    madeleine_sophie_barat_virgin: 'Santa Magdalena Sofía Barat, Vírgen',
    marcellinus_of_rome_and_peter_the_exorcist_martyrs: 'Santos Marcelino y Pedro el Exorcista de Roma, Mártires',
    ...
    marie_eugenie_of_jesus_milleret_de_brou_virgin:
      'Santa María Eugenia de Jesús Milleret de Brou, Vírgen y Fundatrice',
    ...
    mary_of_the_providence_eugenie_smet_virgin: 'Beata María de la Providencia Eugenia Smet, Vírgen',
    mary_of_the_sacred_heart_sophie_therese_de_soubiran_la_louviere_virgin:
      'Beata María Teresa de Soubiran La Louvière, Vírgen',
    ...
    maximilian_mary_raymund_kolbe_priest: 'San Maximiliano María Kolbe, Sacerdote y Mártir',
    ...
    miguel_agustin_pro_priest: 'San Miguel Agustín Pro, Sacerdote y Mártir',
    ...
    nativity_of_the_blessed_virgin_mary: 'Nacimiento de la Santísima Vírgen María',
    nativity_of_the_lord: 'Navidad',
    nereus_of_terracina_and_achilleus_of_terracina_martyrs: 'Santos Nereo y Aquileo de Terracina',
    nicholas_barre_priest: 'Beato Nicolás Barré, Sacerdote',
    nicholas_of_myra_bishop: 'San Nicolás, Obispo',
    norbert_of_xanten_bishop: 'San Norberto de Xanten, Obispo',
    ...
    our_lord_jesus_christ_king_of_the_universe: 'Cristo Rey',
    ...
    pancras_of_rome_martyr: 'San Pancracio de Roma, Mártir',
    paschal_baylon_religious: 'San Pascual Baylón, Religioso franciscano',
    passion_of_saint_john_the_baptist: 'Pasión de San Juan Bautista',
    patrick_of_ireland_bishop: 'San Patricio, Obispo',
    paul_miki_and_companions_martyrs: 'San Pablo Miki y compañeros, Mártires',
    ...
    pelagius_of_cordoba_martyr: 'San Pelayo (Pelagio), Mártir de Córdoba',
    ...
    peter_canisius_priest: 'San Pedro Canisio, Sacerdote y Doctor de la Iglesia',
    peter_chanel_priest: 'San Pedro Chanel, Sacerdote y Mártir',
    peter_chrysologus_bishop: 'San Pedro Crisólogo, Obispo',
    peter_claver_priest: 'San Pedro Claver, Sacerdote',
    ...
    peter_julian_eymard_priest: 'San Pedro Julián Eymard, Sacerdote',
    peter_of_alcantara_priest: 'San Pedro de Alcántara, Sacerdote',
    ...
    pius_francesco_forgione_priest: 'San Pío de Pietrelcina, Sacerdote',
    pius_ix_pope: 'Beato Pío IX, Papa',
    pius_v_pope: 'San Pío V, Papa',
    pius_x_pope: 'San Pío X, Papa',
    polycarp_of_smyrna_bishop: 'San Policarpo de Esmirna, Obispo y Mártir',
    pontian_i_pope_and_hippolytus_of_rome_priest: 'San Ponciano y San Hipólito, Sacerdote',
    presentation_of_the_blessed_virgin_mary: 'Presentación de la Santísima Vírgen María',
    presentation_of_the_lord: 'Presentación de Jesús en el Templo',
    queenship_of_the_blessed_virgin_mary: 'Santísima Vírgen María, Reina del Cielo',
    raphael_guizar_y_valencia_bishop: 'San Rafael Guízar y Valencia, Obispo',
    raymond_of_penyafort_priest: 'San Raymundo de Peñafort, Sacerdote',
    ...
    rosalie_jeanne_marie_rendu_virgin: 'Beata Rosalía Rendu, Vírgen',
    ...
    sebastian_of_milan_martyr: 'San Sebastián de Milán, Mártir',
    seven_holy_founders_of_the_servite_order: 'Los siete santos fundadores de la Orden de los Siervos de María',
    sharbel_makhluf_priest: 'San Charbel, Sacerdote',
    simon_and_jude_apostles: 'Santos Simón y Judas, Apóstoles',
    sixtus_ii_pope_and_companions_martyrs: 'San Sixto II, Papa, y compañeros, Mártires',
    stanislaus_of_szczepanow_bishop: 'San Estanislao de Szczepanów, Obispo y Mártir',
    stephen_i_of_hungary: 'San Esteban I de Hungría',
    ...
    teresa_of_jesus_jornet_ibars_virgin: 'Santa Teresa de Jesús Jornet Ibars, Vírgen',
    teresa_of_jesus_of_avila_virgin: 'Santa Teresa de Jesús, Vírgen y Doctora',
    teresa_of_jesus_of_los_andes_virgin: 'Santa Teresa de Los Andes, Vírgen',
    therese_of_the_child_jesus_and_the_holy_face_of_lisieux_virgin: 'Santa Teresita del Niño Jesús, Vírgen y Doctora',
    therese_of_the_child_jesus_and_the_holy_face_of_lisieux_virgin_copatroness_of_france:
      'Santa Teresita del Niño Jesús, Vírgen y Doctora, Patrona Secundaria de Francia',
    thomas_apostle: 'Santo Tomás, Apóstol',
    thomas_aquinas_priest: 'Santo Tomás de Aquino, Obispo y Doctor',
    thomas_becket_bishop: 'Santo Tomás Becket, Obispo y Mártir',
    thomas_jean_georges_rehm_priest: 'Beato Tomás Juan Jorge Rehm, Sacerdote y Mártir',
    thomas_of_villanova_bishop: 'Santo Tomás de Villanueva, Obispo',
    thursday_of_the_lords_supper: '$(names:holy_thursday)',
    timothy_of_ephesus_and_titus_of_crete_bishops: 'San Timoteo de Éfeso y Tito de Creta, Obispos',
    ...
    turibius_of_mogrovejo_bishop: 'San Toribio de Mogrovejo, Obispo',
    ...
    vincent_ferrer_priest: 'San Vicente Ferrer, Sacerdote',
    vincent_of_saragossa_deacon: 'San Vicente, Diácono y Mártir de Zaragoza',
